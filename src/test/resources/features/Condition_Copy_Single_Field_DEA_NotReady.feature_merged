Feature: Copy Single Field DEA Condition with Not Ready status
  ...
  Scenario Outline: Delete the created conditions
  	...
  	Examples:
  		| Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
  		| QTP_Master_1        | Single | FDECPY8      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  		| QTP_Master_1        | Single | FDECON8      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single Field DEA Condition
  	...
  	Examples:
  		...
  		| Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | FDECON8      | Field DEA Condition8 | Not Ready | Single | Field  | DEA CODE   | Includes       | B           |                      |          |       | Single Field DEA Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: Copy Single Field DEA Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FDECON8      |      | Not Ready |        |       |                      |      | FDECPY8           | Field DEA Condition Copy8 | Not Ready   | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Single Field DEA Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FDECPY8      |      | Not Ready |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFDECPY8     | Name:^Field DEA Condition Copy8 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDFDECPY8 | Name:^Field DEA Condition Copy8 | Status:^Not Ready | Type:^Single | Source:^Field |                           | DEA CODE includes B        | Single Field DEA Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Single Field DEA Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FDECPY8      |      | Not Ready |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
      | QTP_Master_1        | Single | FDECON8      |      | Not Ready |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
