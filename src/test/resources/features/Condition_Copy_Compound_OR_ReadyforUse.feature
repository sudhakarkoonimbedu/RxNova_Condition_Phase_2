Feature: Copy Compound Condition with OR operator and Ready for Use status
  ...
  Scenario Outline: Delete the created conditions
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Compound | CMPCPY7      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
      | QTP_Master_1        | Compound | CMPCON7      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Compound Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | CMPCON7      | Compound Condition7 | Ready for Use | Compound | OR                | Add^TPCOND13^TPCOND14 | Compound Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: Copy Compound OR Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCON7      |      | Ready for Use |        |       |                      |      | CMPCPY7           | Compound Condition Copy7 | Ready for Use | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Compound OR Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCPY7      |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCPY7     | Name:^Compound Condition Copy7 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCPY7 | Name:^Compound Condition Copy7 | Status:^Ready for Use | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND13 | Name^TPCOND13        | Condition ID^CDTPCOND14 | Name^TPCOND14        | CDCMPCPY7: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCPY7: Compound Condition Copy7 | CDTPCOND13: COMPOUND CODE is the same as 1^OR^CDTPCOND14: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Compound Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCPY7      |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
      | QTP_Master_1        | Compound | CMPCON7      |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |