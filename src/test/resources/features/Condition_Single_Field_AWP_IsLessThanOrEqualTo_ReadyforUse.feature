...
Feature: Single Field AWP Cost Condition with Is Less Than or Equal To operator and Ready for Use status
  ...
  Scenario Outline: Delete the created condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Single | FACCON10     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single Field AWP Cost Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | FACCON10     | Field AWP Condition10 | Ready for Use | Single | Field  | AWP COST   | Is Less Than or Equal To | 10          |                      |          |       | Single Field AWP Cost Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: View the Single Field AWP Cost Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FACCON10     |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFACCON10    | Name:^Field AWP Condition10 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFACCON10 | Name:^Field AWP Condition10 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | AWP COST is less than or equal to 10 | Single Field AWP Cost Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Update the Single Field AWP Cost Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FACCON10     |      | Ready for Use |        |       |                      |      | Update Tracking ID | Update Test Reason | Update Test Notes | Update Field AWP Condition10 | Ready for Use | Field         | AWP COST          | Is Less Than or Equal To | 10                 |                 |              | Update Single Field AWP Cost Condition | Remove^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully saved. | 
  ...
  Scenario Outline: View the Single Field AWP Cost Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name                | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                        | Header_Status         | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description           | Notes                                  | Tags |
      | QTP_Master_1        | Single | FACCON10     |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFACCON10    | Name:^Update Field AWP Condition10 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFACCON10 | Name:^Update Field AWP Condition10 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | AWP COST is less than or equal to 10 | Update Single Field AWP Cost Condition |      |
  ...
  Scenario Outline: Delete the Single Field AWP Cost Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FACCON10     |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |