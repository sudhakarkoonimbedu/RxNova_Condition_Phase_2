Feature: Compound Condition with OR operator and Ready for Use status
  ...
  Scenario Outline: Delete the created condition
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Compound | CMPCON4      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Compound Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | CMPCON4      | Compound Condition4 | Ready for Use | Compound | OR                | Add^TPCOND1^TPCOND2   | Compound Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: View the Compound Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCON4      |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON4     | Name:^Compound Condition4 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON4 | Name:^Compound Condition4 | Status:^Ready for Use | Type:^Compound | Source:^Field | Compound operator:^OR  | Condition ID^CDTPCOND1 | Name^TPCOND1         | Condition ID^CDTPCOND2 | Name^TPCOND2         | CDCMPCON4: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON4: Compound Condition4     | CDTPCOND1: COMPOUND CODE is the same as 1^OR^CDTPCOND2: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: View the Compound Condition
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name              | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID     | Header_Name                      | Header_Status         | Header_Type    | View_Source   | View_Compound_Operator | View_Condition_ID1     | View_Condition_Name1 | View_Condition_ID2     | View_Condition_Name2 | View_Condition_Description                                                              | View_Condition_Details_Description    | View_Condition_Details                                                                           | Notes                     | Tags |
      | QTP_Master_1        | Compound | CMPCON4      |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON4     | Name:^Update Compound Condition4 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON4 | Name:^Update Compound Condition4 | Status:^Ready for Use | Type:^Compound | Source:^Field | Compound operator:^OR  | Condition ID^CDTPCOND3 | Name^TPCOND3         | Condition ID^CDTPCOND4 | Name^TPCOND4         | CDCMPCON4: (NDC Name is the same as 18860067870 OR NDC Name is the same as 18860067870) | CDCMPCON4: Update Compound Condition4 | CDTPCOND3: NDC Name is the same as 18860067870^OR^CDTPCOND4: NDC Name is the same as 18860067870 | Update Compound Condition |      |
  ...
  Scenario Outline: Delete the Compound Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCON4      |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |