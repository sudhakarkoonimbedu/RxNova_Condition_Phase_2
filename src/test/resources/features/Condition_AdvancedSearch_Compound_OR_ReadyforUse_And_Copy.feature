...
Feature: Advanced Search Compound Condition with OR operator and Ready for Use status And Copy the Condition
  ...
  Scenario Outline: Delete the created conditions
  	...
  	Examples:
  		| Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
  		| QTP_Master_1        | Compound | CMPCON22     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  		| QTP_Master_1        | Compound | CMPCPY22      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Compound Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | CMPCON22     | Compound Condition22 | Ready for Use | Compound | OR                | Add^TPCOND25^TPCOND26 | Compound Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: Search and View Compound Condition from Search Results table using Master Customer Set
    ...
    Examples: 
       ...
       | QTP_Master_1        |      | Ready for Use | View      | CDCMPCON22   | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON22    | Name:^Compound Condition22 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON22 | Name:^Compound Condition22 | Status:^Ready for Use | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND25 | Name^TPCOND25        | Condition ID^CDTPCOND26 | Name^TPCOND26        | CDCMPCON1: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON1: Compound Condition1     | CDTPCOND25: COMPOUND CODE is the same as 1^OR^CDTPCOND26: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Search and View Compound Condition from Search Results table using Master Customer Set and Type
    ...
    Examples: 
      | Master_Customer_Set | Type     | Status        | Operation | Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name        | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                | Header_Status         | Header_Type    | View_Compound_Operator | View_Condition_ID1      | View_Condition_Name1 | View_Condition_ID2      | View_Condition_Name2 | View_Condition_Description                                                             | View_Condition_Details_Description | View_Condition_Details                                                                            | Notes              | Tags          |
      | QTP_Master_1        | Compound | Ready for Use | View      | CDCMPCON22   | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON22    | Name:^Compound Condition22 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON22 | Name:^Compound Condition22 | Status:^Ready for Use | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND25 | Name^TPCOND25        | Condition ID^CDTPCOND26 | Name^TPCOND26        | CDCMPCON1: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON1: Compound Condition1     | CDTPCOND25: COMPOUND CODE is the same as 1^OR^CDTPCOND26: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Search and View Compound Condition using Condition ID
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCON22     |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON22    | Name:^Compound Condition22 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON22 | Name:^Compound Condition22 | Status:^Ready for Use | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND25 | Name^TPCOND25        | Condition ID^CDTPCOND26 | Name^TPCOND26        | CDCMPCON1: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON1: Compound Condition1     | CDTPCOND25: COMPOUND CODE is the same as 1^OR^CDTPCOND26: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Search and View Compound Condition using Condition ID and Source details
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status        | Source | Field         | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name        | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                | Header_Status         | Header_Type    | View_Compound_Operator | View_Condition_ID1      | View_Condition_Name1 | View_Condition_ID2      | View_Condition_Name2 | View_Condition_Description                                                             | View_Condition_Details_Description | View_Condition_Details                                                                            | Notes              | Tags          |
      | QTP_Master_1        | Compound | CMPCON22     |      | Ready for Use | Field  | COMPOUND CODE |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON22    | Name:^Compound Condition22 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON22 | Name:^Compound Condition22 | Status:^Ready for Use | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND25 | Name^TPCOND25        | Condition ID^CDTPCOND26 | Name^TPCOND26        | CDCMPCON1: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON1: Compound Condition1     | CDTPCOND25: COMPOUND CODE is the same as 1^OR^CDTPCOND26: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View Compound Condition from Search Results table using Master Customer Set and Sub-status
    ...
    Examples: 
      ...
      | QTP_Master_1        |      |              |      | Ready for Use |        |       |                      |      | Not Associated |      |                          |                             | View      | CDCMPCON22        | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON22    | Name:^Compound Condition22 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON22 | Name:^Compound Condition22 | Status:^Ready for Use | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND25 | Name^TPCOND25        | Condition ID^CDTPCOND26 | Name^TPCOND26        | CDCMPCON1: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON1: Compound Condition1     | CDTPCOND25: COMPOUND CODE is the same as 1^OR^CDTPCOND26: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View Compound Condition from Search Results table using Master Customer Set, Type and Sub-status
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Sub_Status     | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name        | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                | Header_Status         | Header_Type    | View_Compound_Operator | View_Condition_ID1      | View_Condition_Name1 | View_Condition_ID2      | View_Condition_Name2 | View_Condition_Description                                                             | View_Condition_Details_Description | View_Condition_Details                                                                            | Notes              | Tags          |
      | QTP_Master_1        | Compound |              |      | Ready for Use |        |       |                      |      | Not Associated |      |                          |                             | View      | CDCMPCON22        | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON22    | Name:^Compound Condition22 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON22 | Name:^Compound Condition22 | Status:^Ready for Use | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND25 | Name^TPCOND25        | Condition ID^CDTPCOND26 | Name^TPCOND26        | CDCMPCON1: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON1: Compound Condition1     | CDTPCOND25: COMPOUND CODE is the same as 1^OR^CDTPCOND26: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View Compound Condition using Condition ID and Sub-status
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Sub_Status     | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name        | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                | Header_Status         | Header_Type    | View_Compound_Operator | View_Condition_ID1      | View_Condition_Name1 | View_Condition_ID2      | View_Condition_Name2 | View_Condition_Description                                                             | View_Condition_Details_Description | View_Condition_Details                                                                            | Notes              | Tags          |
      | QTP_Master_1        | Compound | CMPCON22     |      | Ready for Use |        |       |                      |      | Not Associated |      |                          |                             |           |                   | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON22    | Name:^Compound Condition22 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON22 | Name:^Compound Condition22 | Status:^Ready for Use | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND25 | Name^TPCOND25        | Condition ID^CDTPCOND26 | Name^TPCOND26        | CDCMPCON1: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON1: Compound Condition1     | CDTPCOND25: COMPOUND CODE is the same as 1^OR^CDTPCOND26: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View Compound Condition using Condition Name and Sub-status
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name                 | Status        | Source | Field | Benefit_Customer_Set | List | Sub_Status     | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name        | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                | Header_Status         | Header_Type    | View_Compound_Operator | View_Condition_ID1      | View_Condition_Name1 | View_Condition_ID2      | View_Condition_Name2 | View_Condition_Description                                                             | View_Condition_Details_Description | View_Condition_Details                                                                            | Notes              | Tags          |
      | QTP_Master_1        | Compound |              | Compound Condition22 | Ready for Use |        |       |                      |      | Not Associated |      |                          |                             |           |                   | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON22    | Name:^Compound Condition22 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON22 | Name:^Compound Condition22 | Status:^Ready for Use | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND25 | Name^TPCOND25        | Condition ID^CDTPCOND26 | Name^TPCOND26        | CDCMPCON1: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON1: Compound Condition1     | CDTPCOND25: COMPOUND CODE is the same as 1^OR^CDTPCOND26: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View Compound Condition using Condition ID, Sub-status and Source details
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status        | Source | Field         | Benefit_Customer_Set | List | Sub_Status     | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name        | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                | Header_Status         | Header_Type    | View_Compound_Operator | View_Condition_ID1      | View_Condition_Name1 | View_Condition_ID2      | View_Condition_Name2 | View_Condition_Description                                                             | View_Condition_Details_Description | View_Condition_Details                                                                            | Notes              | Tags          |
      | QTP_Master_1        | Compound | CMPCON22     |      | Ready for Use | Field  | COMPOUND CODE |                      |      | Not Associated |      |                          |                             |           |                   | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON22    | Name:^Compound Condition22 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON22 | Name:^Compound Condition22 | Status:^Ready for Use | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND25 | Name^TPCOND25        | Condition ID^CDTPCOND26 | Name^TPCOND26        | CDCMPCON1: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON1: Compound Condition1     | CDTPCOND25: COMPOUND CODE is the same as 1^OR^CDTPCOND26: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
 ...
 #Scenario Outline: Search and View Compound Condition using Condition ID, Sub status and Tags       ***** This Search condition is commented due to application issue with Tags *****
    ...
    #Examples: 
      #| Master_Customer_Set | Type     | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Sub_Status     | Tags     | Tags_Add_Success_Message                 | Tags_Remove_Success_Message                           | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name        | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                | Header_Status         | Header_Type    | View_Compound_Operator | View_Condition_ID1      | View_Condition_Name1 | View_Condition_ID2      | View_Condition_Name2 | View_Condition_Description                                                             | View_Condition_Details_Description | View_Condition_Details                                                                            | Notes              | Tags          |
      #| QTP_Master_1        | Compound | CMPCON22     |      | Ready for Use |        |       |                      |      | Not Associated | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. |           |                   | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON22    | Name:^Compound Condition22 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON22 | Name:^Compound Condition22 | Status:^Ready for Use | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND25 | Name^TPCOND25        | Condition ID^CDTPCOND26 | Name^TPCOND26        | CDCMPCON1: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON1: Compound Condition1     | CDTPCOND25: COMPOUND CODE is the same as 1^OR^CDTPCOND26: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Wildcard search using Condition ID and View Compound Condition
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Sub_Status | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name        | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                | Header_Status         | Header_Type    | View_Compound_Operator | View_Condition_ID1      | View_Condition_Name1 | View_Condition_ID2      | View_Condition_Name2 | View_Condition_Description                                                             | View_Condition_Details_Description | View_Condition_Details                                                                            | Notes              | Tags          |
      | QTP_Master_1        | Compound | *CON*        |      | Ready for Use |        |       |                      |      |            |      |                          |                             | View      | CDCMPCON22        | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON22    | Name:^Compound Condition22 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON22 | Name:^Compound Condition22 | Status:^Ready for Use | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND25 | Name^TPCOND25        | Condition ID^CDTPCOND26 | Name^TPCOND26        | CDCMPCON1: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON1: Compound Condition1     | CDTPCOND25: COMPOUND CODE is the same as 1^OR^CDTPCOND26: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Wildcard search using Condition Name and View Compound Condition
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name        | Status        | Source | Field | Benefit_Customer_Set | List | Sub_Status | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name        | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                | Header_Status         | Header_Type    | View_Compound_Operator | View_Condition_ID1      | View_Condition_Name1 | View_Condition_ID2      | View_Condition_Name2 | View_Condition_Description                                                             | View_Condition_Details_Description | View_Condition_Details                                                                            | Notes              | Tags          |
      | QTP_Master_1        | Compound |              | *Condition* | Ready for Use |        |       |                      |      |            |      |                          |                             | View      | CDCMPCON22        | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON22    | Name:^Compound Condition22 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON22 | Name:^Compound Condition22 | Status:^Ready for Use | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND25 | Name^TPCOND25        | Condition ID^CDTPCOND26 | Name^TPCOND26        | CDCMPCON1: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON1: Compound Condition1     | CDTPCOND25: COMPOUND CODE is the same as 1^OR^CDTPCOND26: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  
  
  Scenario Outline: Copy Compound OR Condition
    Given User search for the existing condition with the following details
      | Master_Customer_Set   | Type   | Condition_ID   | Name   | Status   | Source   | Field   | Benefit_Customer_Set   | List   |  
      | <Master_Customer_Set> | <Type> | <Condition_ID> | <Name> | <Status> | <Source> | <Field> | <Benefit_Customer_Set> | <List> |
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCON22      |      | Ready for Use |        |       |                      |      | CMPCPY22           | Compound Condition Copy22 | Ready for Use | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Compound OR Condition
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name            | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID     | Header_Name                    | Header_Status         | Header_Type    | View_Compound_Operator | View_Condition_ID1      | View_Condition_Name1 | View_Condition_ID2      | View_Condition_Name2 | View_Condition_Description                                                             | View_Condition_Details_Description  | View_Condition_Details                                                                            | Notes              | Tags          |
      | QTP_Master_1        | Compound | CMPCPY22      |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCPY22     | Name:^Compound Condition Copy22 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCPY22 | Name:^Compound Condition Copy22 | Status:^Ready for Use | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND13 | Name^TPCOND13        | Condition ID^CDTPCOND14 | Name^TPCOND14        | CDCMPCPY22: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCPY22: Compound Condition Copy22 | CDTPCOND13: COMPOUND CODE is the same as 1^OR^CDTPCOND14: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Compound Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCON22     |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
      | QTP_Master_1        | Compound | CMPCPY22      |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |    
