Feature: Advanced Search Single Field DEA Code Condition with Ready for Use status And Copy the Condition
  ...
  Scenario Outline: Delete the created conditions
  	...
  	Examples:
  		| Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
  		| QTP_Master_1        | Single | FDECON13     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  		| QTP_Master_1        | Single | FDECPY13      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single Field DEA Code Condition
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | FDECON13     | Field DEA Condition13 | Ready for Use | Single | Field  | DEA CODE   | Includes       | D           |                      |          |       | Single Field DEA Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: Search and View Single Field DEA Code Condition from Search Results table using Master Customer Set
    ...
    Examples: 
      ...
      | QTP_Master_1        |      | Ready for Use | View      | CDFDECON13   | Master customer set:^QTP_Master_1  | Condition ID:^CDFDECON13    | Name:^Field DEA Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFDECON13 | Name:^Field DEA Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | DEA CODE includes D         | Single Field DEA Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Search and View Single Field DEA Code Condition from Search Results table using Master Customer Set and Type
    ...
    Examples: 
      | Master_Customer_Set | Type   | Status        | Operation | Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status         | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description  | Notes                      | Tags          |
      | QTP_Master_1        | Single | Ready for Use | View      | CDFDECON13   | Master customer set:^QTP_Master_1  | Condition ID:^CDFDECON13    | Name:^Field DEA Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFDECON13 | Name:^Field DEA Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | DEA CODE includes D         | Single Field DEA Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Search and View Single Field DEA Code Condition using Condition ID
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FDECON13     |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFDECON13    | Name:^Field DEA Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFDECON13 | Name:^Field DEA Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | DEA CODE includes D         | Single Field DEA Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Search and View Single Field DEA Code Condition using Condition Name
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name                  | Status        | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status         | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description  | Notes                      | Tags          |
      | QTP_Master_1        | Single |              | Field DEA Condition13 | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFDECON13    | Name:^Field DEA Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFDECON13 | Name:^Field DEA Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | DEA CODE includes D         | Single Field DEA Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Search and View Single Field DEA Code Condition using Condition ID and Source details
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status        | Source | Field    | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status         | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description  | Notes                      | Tags          |
      | QTP_Master_1        | Single | FDECON13     |      | Ready for Use | Field  | DEA CODE |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFDECON13    | Name:^Field DEA Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFDECON13 | Name:^Field DEA Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | DEA CODE includes D         | Single Field DEA Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View Single Field DEA Code Condition from Search Results table using Master Customer Set and Sub-status
    ...
    Examples: 
      ...
      | QTP_Master_1        |      |              |      | Ready for Use |        |       |                      |      | Not Associated |      |                          |                             | View      | CDFDECON13        | Master customer set:^QTP_Master_1  | Condition ID:^CDFDECON13    | Name:^Field DEA Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFDECON13 | Name:^Field DEA Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | DEA CODE includes D         | Single Field DEA Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View Single Field DEA Code Condition from Search Results table using Master Customer Set, Type and Sub-status
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Sub_Status     | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status         | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description  | Notes                      | Tags          |
      | QTP_Master_1        | Single |              |      | Ready for Use |        |       |                      |      | Not Associated |      |                          |                             | View      | CDFDECON13        | Master customer set:^QTP_Master_1  | Condition ID:^CDFDECON13    | Name:^Field DEA Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFDECON13 | Name:^Field DEA Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | DEA CODE includes D         | Single Field DEA Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View Single Field DEA Code Condition using Condition ID and Sub-status
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Sub_Status     | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status         | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description  | Notes                      | Tags          |
      | QTP_Master_1        | Single | FDECON13     |      | Ready for Use |        |       |                      |      | Not Associated |      |                          |                             |           |                   | Master customer set:^QTP_Master_1  | Condition ID:^CDFDECON13    | Name:^Field DEA Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFDECON13 | Name:^Field DEA Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | DEA CODE includes D         | Single Field DEA Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View Single Field DEA Code Condition using Condition Name and Sub-status
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name                  | Status        | Source | Field | Benefit_Customer_Set | List | Sub_Status     | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status         | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description  | Notes                      | Tags          |
      | QTP_Master_1        | Single |              | Field DEA Condition13 | Ready for Use |        |       |                      |      | Not Associated |      |                          |                             |           |                   | Master customer set:^QTP_Master_1  | Condition ID:^CDFDECON13    | Name:^Field DEA Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFDECON13 | Name:^Field DEA Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | DEA CODE includes D         | Single Field DEA Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View Single Field DEA Code Condition using Condition ID, Sub-status and Source details
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status        | Source | Field    | Benefit_Customer_Set | List | Sub_Status     | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status         | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description  | Notes                      | Tags          |
      | QTP_Master_1        | Single | FDECON13     |      | Ready for Use | Field  | DEA CODE |                      |      | Not Associated |      |                          |                             |           |                   | Master customer set:^QTP_Master_1  | Condition ID:^CDFDECON13    | Name:^Field DEA Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFDECON13 | Name:^Field DEA Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | DEA CODE includes D         | Single Field DEA Condition | Tag Name^tag1 |
 ...
 #Scenario Outline: Search and View Single Field DEA Code Condition using Condition ID, Sub status and Tags       ***** This Search condition is commented due to application issue with Tags *****
    ...
    #Examples: 
      #| Master_Customer_Set | Type   | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Sub_Status     | Tags     | Tags_Add_Success_Message                 | Tags_Remove_Success_Message                           | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status         | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description  | Notes                      | Tags          |
      #| QTP_Master_1        | Single | FDECON13     |      | Ready for Use |        |       |                      |      | Not Associated | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. |           |                   | Master customer set:^QTP_Master_1  | Condition ID:^CDFDECON13    | Name:^Field DEA Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFDECON13 | Name:^Field DEA Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | DEA CODE includes D         | Single Field DEA Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Wildcard search using Condition ID and View Single Field DEA Code Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Sub_Status | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status         | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description  | Notes                      | Tags          |
      | QTP_Master_1        | Single | *CON*        |      | Ready for Use |        |       |                      |      |            |      |                          |                             | View      | CDFDECON13        | Master customer set:^QTP_Master_1  | Condition ID:^CDFDECON13    | Name:^Field DEA Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFDECON13 | Name:^Field DEA Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | DEA CODE includes D         | Single Field DEA Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Wildcard search using Condition Name and View Single Field DEA Code Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name        | Status        | Source | Field | Benefit_Customer_Set | List | Sub_Status | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status         | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description  | Notes                      | Tags          |
      | QTP_Master_1        | Single |              | *Condition* | Ready for Use |        |       |                      |      |            |      |                          |                             | View      | CDFDECON13        | Master customer set:^QTP_Master_1  | Condition ID:^CDFDECON13    | Name:^Field DEA Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFDECON13 | Name:^Field DEA Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | DEA CODE includes D         | Single Field DEA Condition | Tag Name^tag1 |
 ...
 Scenario Outline: Copy Single Field DEA Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FDECON13      |      | Ready for Use |        |       |                      |      | FDECPY13           | Field DEA Condition Copy13 | Ready for Use | Test TrackingID |             |            | The condition was successfully copied. |
 ...
 Scenario Outline: View the Copied Single Field DEA Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name             | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID     | Header_Name                     | Header_Status         | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description | Notes                      | Tags          |
      | QTP_Master_1        | Single | FDECPY13      |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFDECPY13     | Name:^Field DEA Condition Copy13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFDECPY13 | Name:^Field DEA Condition Copy13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | DEA CODE includes A        | Single Field DEA Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Single Single Field DEA Code Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FDECON13     |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
     | QTP_Master_1        | Single | FDECPY13      |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |    
