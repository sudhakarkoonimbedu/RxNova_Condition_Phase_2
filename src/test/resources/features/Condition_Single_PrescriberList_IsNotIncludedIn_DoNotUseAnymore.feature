Feature: Single Prescriber List Condition with Is Not Included In operator and Do Not Use Anymore status
  ...
  Scenario Outline: Delete the created condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Single | PRECOND3     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single PrescriberList Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | PRECOND3     | Prescriber List Condition3 | Do Not Use Anymore | Single | Prescriber List |            |                |             | QTP_Benefits         | Is Not Included In | PBTPPRI3 | Single Prescriber List Condition3 | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |

  Scenario Outline: View the Single PrescriberList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | PRECOND3     |      | Do Not Use Anymore |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDPRECOND3    | Name:^Prescriber List Condition3 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDPRECOND3 | Name:^Prescriber List Condition3 | Status:^Do Not Use Anymore | Type:^Single | Source:^Prescriber List | Benefit customer set:^QTP_Benefits | Prescriber is not included in prescriber list PBTPPRI3 | Single Prescriber List Condition3 | Tag Name^tag1 |
  
  Scenario Outline: Update the Single PrescriberList Condition
    Given User search for the existing condition with the following details
      | Master_Customer_Set   | Type   | Condition_ID   | Name   | Status   | Source   | Field   | Benefit_Customer_Set   | List   |  
      | <Master_Customer_Set> | <Type> | <Condition_ID> | <Name> | <Status> | <Source> | <Field> | <Benefit_Customer_Set> | <List> |
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | PRECOND3     |       | Do Not Use Anymore |           |       |                      |      | Update Tracking ID | Update Test Reason | Update Test Notes | Update Prescriber List Condition3 | Do Not Use Anymore | Prescriber List |                   |                       |                    | Is Not Included In | PBTPPRI3     | Update Single Prescriber List Condition3 | Remove^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully saved. | 
  ...
  Scenario Outline: View the Single PrescriberList Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status             | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name                     | Header_Summary_Status      | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                             | Header_Status              | Header_Type  | View_Source             | View_Benefit_Customer_Set          | View_Condition_Description                             | Notes                                    | Tags |
      | QTP_Master_1        | Single | PRECOND3     |      | Do Not Use Anymore |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDPRECOND3    | Name:^Update Prescriber List Condition3 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDPRECOND3 | Name:^Update Prescriber List Condition3 | Status:^Do Not Use Anymore | Type:^Single | Source:^Prescriber List | Benefit customer set:^QTP_Benefits | Prescriber is not included in prescriber list PBTPPRI3 | Update Single Prescriber List Condition3 |      |
  ...
  Scenario Outline: Delete the Single PrescriberList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | PRECOND3     |      | Do Not Use Anymore |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |