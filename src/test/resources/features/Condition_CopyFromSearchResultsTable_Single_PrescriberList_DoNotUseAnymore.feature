...
Feature: Copy Single Prescriber List Condition with Do Not Use Anymore status from Search Results table
  ...
  Scenario Outline: Delete the created conditions
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Single | PRECPY12     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
      | QTP_Master_1        | Single | PRECON12     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single PrescriberList Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | PRECON12     | Prescriber List Condition12 | Do Not Use Anymore | Single | Prescriber List |            |                |             | QTP_Benefits         | Is Not Included In | PBTPPRI6 | Single Prescriber List Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |

  Scenario Outline: Copy Single PrescriberList Condition from Search Results table
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | Do Not Use Anymore | Copy      | CDPRECON12   | PRECPY12          | Prescriber List Condition Copy12 | Do Not Use Anymore | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Single PrescriberList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | PRECPY12     |      | Do Not Use Anymore |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDPRECPY12    | Name:^Prescriber List Condition Copy12 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDPRECPY12 | Name:^Prescriber List Condition Copy12 | Status:^Do Not Use Anymore | Type:^Single | Source:^Prescriber List | Benefit customer set:^QTP_Benefits | Prescriber is not included in prescriber list PBTPPRI6 | Single Prescriber List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Single PrescriberList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | PRECPY12     |      | Do Not Use Anymore |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
      | QTP_Master_1        | Single | PRECON12     |      | Do Not Use Anymore |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
