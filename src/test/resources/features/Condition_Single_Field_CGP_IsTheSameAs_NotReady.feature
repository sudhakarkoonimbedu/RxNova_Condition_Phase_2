...
Feature: Single Field City Group Condition with Is the Same As operator and Not Ready status
  ...
  Scenario Outline: Delete the created condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Single | FCGCON2      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single Field City Group Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | FCGCON2      | Field CGP Condition2 | Not Ready | Single | Field  | CITY - GROUP | Is the Same As | FLORIDA     |                      |          |       | Single Field Custom Group Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: View the Single Field City Group Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FCGCON2      |      | Not Ready |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFCGCON2     | Name:^Field CGP Condition2 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDFCGCON2 | Name:^Field CGP Condition2 | Status:^Not Ready | Type:^Single | Source:^Field |                           | CITY - GROUP is the same as FLORIDA | Single Field Custom Group Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Update the Single Field City Group Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FCGCON2      |      | Not Ready |           |       |                      |      | Update Tracking ID | Update Test Reason | Update Test Notes | Update Field CGP Condition2 | Not Ready     | Field         | CITY - GROUP      | Is the Same As        | FLORIDA            |                 |              | Update Single Field Custom Group Condition | Remove^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully saved. | 
  ...
  Scenario Outline: View the Single Field City Group Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status    | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name               | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID     | Header_Name                       | Header_Status     | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description          | Notes                                      | Tags |
      | QTP_Master_1        | Single | FCGCON2      |      | Not Ready |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFCGCON2     | Name:^Update Field CGP Condition2 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDFCGCON2 | Name:^Update Field CGP Condition2 | Status:^Not Ready | Type:^Single | Source:^Field |                           | CITY - GROUP is the same as FLORIDA | Update Single Field Custom Group Condition |      |
  ...
  Scenario Outline: Delete the Single Field City Group Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FCGCON2      |      | Not Ready |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |