Feature: Copy Single Drug List Condition with Ready for Use status
  ...
  Scenario Outline: Delete the created conditions
  	...
  	Examples:
  		| Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
  		| QTP_Master_1        | Single | DRGCPY7      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  		| QTP_Master_1        | Single | DRGCON7      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single DrugList Condition
  	...
  	Examples:
  		...
  		| Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | DRGCON7      | Drug List Condition7 | Ready for Use | Single | Drug List |            |                |             | QTP_Benefits         | Is Included In | FLTPDLI4 | Single Drug List Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: Copy Single DrugList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | DRGCON7      |      | Ready for Use |        |       |                      |      | DRGCPY7           | Drug List Condition Copy7 | Ready for Use | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Single DrugList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | DRGCPY7      |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDDRGCPY7     | Name:^Drug List Condition Copy7 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDDRGCPY7 | Name:^Drug List Condition Copy7 | Status:^Ready for Use | Type:^Single | Source:^Drug List | Benefit customer set:^QTP_Benefits | Drug is included in drug list FLTPDLI4 | Single Drug List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Single DrugList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | DRGCPY7      |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
      | QTP_Master_1        | Single | DRGCON7      |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
