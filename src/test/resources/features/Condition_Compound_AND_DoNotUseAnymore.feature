...
Feature: Compound Condition with AND operator and Do Not Use Anymore status
  ...
  Scenario Outline: Delete the created condition
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status      | Delete_Tracking_ID |
      | QTP_Master_1        | Compound | CMPCON3      |      |        | Update Tracking ID | Do Not Use Anymore | Delete Tracking ID |
  ...
  Scenario Outline: Add the Compound Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | CMPCON3      | Compound Condition3 | Do Not Use Anymore | Compound | AND               | Add^TPCOND9^TPCOND10  | Compound Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: View the Compound Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCON3      |      | Do Not Use Anymore |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON3     | Name:^Compound Condition3 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON3 | Name:^Compound Condition3 | Status:^Do Not Use Anymore | Type:^Compound | Compound operator:^AND | Condition ID^CDTPCOND9 | Name^TPCOND9         | Condition ID^CDTPCOND10 | Name^TPCOND10        | CDCMPCON3: (COMPOUND CODE is the same as 1 AND NDC Name is not the same as 18860067870) | CDCMPCON3: Compound Condition3     | CDTPCOND9: COMPOUND CODE is the same as 1^AND^CDTPCOND10: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Update the Compound Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCON3      |      | Do Not Use Anymore |           |       |                      |      | Update Tracking ID | Update Test Reason | Update Test Notes | Update Compound Condition3 | Do Not Use Anymore | AND                      | Remove^CDTPCOND9^CDTPCOND10#Add^TPCOND11^TPCOND12 | Update Compound Condition | Remove^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully saved. | 
  ...
  Scenario Outline: View the Compound Condition
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status             | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name              | Header_Summary_Status      | Header_Master_Customer_Set        | Header_Condition_ID     | Header_Name                      | Header_Status              | Header_Type    | View_Compound_Operator | View_Condition_ID1      | View_Condition_Name1 | View_Condition_ID2      | View_Condition_Name2 | View_Condition_Description                                                               | View_Condition_Details_Description    | View_Condition_Details                                                                              | Notes                     | Tags |
      | QTP_Master_1        | Compound | CMPCON3      |      | Do Not Use Anymore |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON3     | Name:^Update Compound Condition3 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON3 | Name:^Update Compound Condition3 | Status:^Do Not Use Anymore | Type:^Compound | Compound operator:^AND | Condition ID^CDTPCOND11 | Name^TPCOND11        | Condition ID^CDTPCOND12 | Name^TPCOND12        | CDCMPCON3: (NDC Name is the same as 18860067870 AND NDC Name is the same as 18860067870) | CDCMPCON3: Update Compound Condition3 | CDTPCOND11: NDC Name is the same as 18860067870^AND^CDTPCOND12: NDC Name is the same as 18860067870 | Update Compound Condition |      |
  ...
  Scenario Outline: Delete the Compound Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCON3      |      | Do Not Use Anymore |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |