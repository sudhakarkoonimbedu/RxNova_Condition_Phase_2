...
Feature: Copy Single Field NDC Condition with Ready for Use status from Search Results table
  ...
  Scenario Outline: Add the Single Field NDC Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | FNDCON10     | Field NDC Condition10 | Ready for Use | Single | Field  | NDC Name   | Is Not the Same As | 89754692315 |                      |          |       | Single Field NDC Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
