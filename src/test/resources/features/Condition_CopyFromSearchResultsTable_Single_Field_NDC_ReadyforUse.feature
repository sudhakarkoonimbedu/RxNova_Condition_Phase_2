Feature: Copy Single Field NDC Condition with Ready for Use status from Search Results table
  ...
  Scenario Outline: Delete the created conditions
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Single | FNDCPY10     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
      | QTP_Master_1        | Single | FNDCON10     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single Field NDC Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | FNDCON10     | Field NDC Condition10 | Ready for Use | Single | Field  | NDC Name   | Is Not the Same As | 89754612315 |                      |          |       | Single Field NDC Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: Copy Single Field NDC Condition from Search Results table
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | Ready for Use | Copy      | CDFNDCON10   | FNDCPY10          | Field NDC Condition Copy10 | Ready for Use | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Single Field NDC Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FNDCPY10     |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFNDCPY10    | Name:^Field NDC Condition Copy10 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFNDCPY10 | Name:^Field NDC Condition Copy10 | Status:^Ready for Use | Type:^Single | Source:^Field NDC |                           | NDC NAME is not the same as 89754612315 | Single Field NDC Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Single Field NDC Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FNDCPY10     |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
      | QTP_Master_1        | Single | FNDCON10     |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
