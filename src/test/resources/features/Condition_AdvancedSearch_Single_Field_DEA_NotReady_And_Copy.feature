...
Feature: Advanced Search Single Field DEA Code Condition with Not Ready status And Copy the Condition
  ...
  Scenario Outline: Delete the created conditions
  	...
  	Examples:
  		...
  		| QTP_Master_1        | Single | FDECPY14     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
 ...
 #Scenario Outline: Search and View Single Field DEA Code Condition using Condition ID, Sub status and Tags       ***** This Search condition is commented due to application issue with Tags *****
  ...
  Scenario Outline: Wildcard search using Condition Name and View Single Field DEA Code Condition
   ...
   Scenario Outline: Copy Single Field DEA Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FDECON14      |      | Not Ready |        |       |                      |      | FDECPY14          | Field DEA Condition Copy14| Not Ready   | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Single Field DEA Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status    | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name             | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID     | Header_Name                     | Header_Status     | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description | Notes                      | Tags          |
      | QTP_Master_1        | Single | FDECPY14     |      | Not Ready |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFDECPY14    | Name:^Field DEA Condition Copy14| Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDFDECPY14| Name:^Field DEA Condition Copy14| Status:^Not Ready | Type:^Single | Source:^Field |                           | DEA CODE includes B        | Single Field DEA Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Single Single Field DEA Code Condition
    ...
    Examples: 
	  ...
	  | QTP_Master_1        | Single | FDECPY14     |      | Not Ready |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |