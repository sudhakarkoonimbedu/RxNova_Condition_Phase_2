...
Feature: Single Prescriber List Condition with Is Included In operator and Ready for Use status
  ...
  Scenario Outline: Delete the created condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID  | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Single | PRECOND4      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single PrescriberList Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | PRECOND4      | Prescriber List Condition4 | Ready for Use | Single | Prescriber List |            |                |             | QTP_Benefits         | Is Included In | PBTPPRI1 | Single Prescriber List Condition4 | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: View the Single PrescriberList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | PRECOND4      |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDPRECOND4     | Name:^Prescriber List Condition4 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDPRECOND4 | Name:^Prescriber List Condition4 | Status:^Ready for Use | Type:^Single | Source:^Prescriber List | Benefit customer set:^QTP_Benefits | Prescriber is not included in prescriber list PBTPPRI1 | Single Prescriber List Condition4 | Tag Name^tag1 |
  ...
  Scenario Outline: Update the Single PrescriberList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | PRECOND4     |       | Ready for Use |           |       |                      |      | Update Tracking ID | Update Test Reason | Update Test Notes | Update Prescriber List Condition4 | Ready for Use | Prescriber List |                   |                       |                    | Is Included In  | PBTPPRI1     | Update Single Prescriber List Condition4 | Remove^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully saved. | 
  ...
  Scenario Outline: View the Single PrescriberList Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name                     | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                             | Header_Status         | Header_Type  | View_Source             | View_Benefit_Customer_Set          | View_Condition_Description                             | Notes                                    | Tags |
      | QTP_Master_1        | Single | PRECOND4     |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDPRECOND4    | Name:^Update Prescriber List Condition4 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDPRECOND4 | Name:^Update Prescriber List Condition4 | Status:^Ready for Use | Type:^Single | Source:^Prescriber List | Benefit customer set:^QTP_Benefits | Prescriber is not included in prescriber list PBTPPRI1 | Update Single Prescriber List Condition4 |      |
  ...
  Scenario Outline: Delete the Single PrescriberList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | PRECOND4     |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |