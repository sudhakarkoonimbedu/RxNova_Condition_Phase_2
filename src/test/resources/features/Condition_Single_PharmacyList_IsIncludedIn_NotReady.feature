Feature: Single Pharmacy List Condition with Is Included In operator and Not Ready status
  ...
  Scenario Outline: Delete the created condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Single | PHRCOND5     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single PharmacyList Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | PHRCOND5     | Pharmacy List Condition5 | Not Ready | Single | Pharmacy List |            |                |             | QTP_Benefits         | Is Included In | PTTPPHI2 | Single Pharmacy List Condition5 | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: View the Single PharmacyList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | PHRCOND5     |      | Not Ready |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDPHRCOND5    | Name:^Pharmacy List Condition5 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDPHRCOND5 | Name:^Pharmacy List Condition5 | Status:^Not Ready | Type:^Single | Source:^Pharmacy List |                           | Pharmacy is not included in Pharmacy list PTTPPHI2 | Single Pharmacy List Condition5 | Tag Name^tag1 |
  ...
  Scenario Outline: Update the Single PharmacyList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | PHRCOND5     |       | Not Ready |           |       |                      |      | Update Tracking ID | Update Test Reason | Update Test Notes | Update Pharmacy List Condition5 | Not Ready     | Pharmacy List |                   |                       |                    | Is Included In  | PTTPPHI2     | Update Single Pharmacy List Condition5 | Remove^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully saved. | 
  ...
  Scenario Outline: View the Single PharmacyList Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status    | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name                   | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                           | Header_Status     | Header_Type  | View_Source           | View_Benefit_Customer_Set | View_Condition_Description                         | Notes                                  | Tags |
      | QTP_Master_1        | Single | PHRCOND5     |      | Not Ready |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDPHRCOND5    | Name:^Update Pharmacy List Condition5 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDPHRCOND5 | Name:^Update Pharmacy List Condition5 | Status:^Not Ready | Type:^Single | Source:^Pharmacy List |                           | Pharmacy is not included in Pharmacy list PTTPPHI2 | Update Single Pharmacy List Condition5 |      |
  ...
  Scenario Outline: Delete the Single PharmacyList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | PHRCOND5     |      | Not Ready |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |