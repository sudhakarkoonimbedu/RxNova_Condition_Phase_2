Feature: Advanced Search Single Field NDC Name Condition with Ready for Use status And Copy the condition
  ...
  Scenario Outline: Delete the created conditions
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Single | FNDCON13     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
      | QTP_Master_1        | Single | FNDCPY13      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single Field NDC Name Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | FNDCON13     | Field NDC Condition13 | Ready for Use | Single | Field  | NDC Name   | Is the Same As | 89754612315 |                      |          |       | Single Field NDC Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: Search and View Single Field NDC Name Condition from Search Results table using Master Customer Set
    ...
    Examples: 
      ...
      | QTP_Master_1        |      | Ready for Use | View      | CDFNDCON13   | Master customer set:^QTP_Master_1  | Condition ID:^CDFNDCON13    | Name:^Field NDC Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFNDCON13 | Name:^Field NDC Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | NDC Name is the same as 89754612315 | Single Field NDC Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Search and View Single Field NDC Name Condition from Search Results table using Master Customer Set and Type
    ...
    Examples: 
      | Master_Customer_Set | Type   | Status        | Operation | Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status         | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description          | Notes                      | Tags          |
      | QTP_Master_1        | Single | Ready for Use | View      | CDFNDCON13   | Master customer set:^QTP_Master_1  | Condition ID:^CDFNDCON13    | Name:^Field NDC Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFNDCON13 | Name:^Field NDC Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | NDC Name is the same as 89754612315 | Single Field NDC Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Search and View Single Field NDC Name Condition using Condition ID
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FNDCON13     |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFNDCON13    | Name:^Field NDC Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFNDCON13 | Name:^Field NDC Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | NDC Name is the same as 89754612315 | Single Field NDC Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Search and View Single Field NDC Name Condition using Condition Name
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name                  | Status        | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status         | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description          | Notes                      | Tags          |
      | QTP_Master_1        | Single |              | Field NDC Condition13 | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFNDCON13    | Name:^Field NDC Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFNDCON13 | Name:^Field NDC Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | NDC Name is the same as 89754612315 | Single Field NDC Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Search and View Single Field NDC Name Condition using Condition ID and Source details
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status        | Source | Field    | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status         | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description          | Notes                      | Tags          |
      | QTP_Master_1        | Single | FNDCON13     |      | Ready for Use | Field  | NDC Name |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFNDCON13    | Name:^Field NDC Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFNDCON13 | Name:^Field NDC Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | NDC Name is the same as 89754612315 | Single Field NDC Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View Single Field NDC Name Condition from Search Results table using Master Customer Set and Sub-status
    ...
    Examples: 
      ...
      | QTP_Master_1        |      |              |      | Ready for Use |        |       |                      |      | Not Associated |      |                          |                             | View      | CDFNDCON13        | Master customer set:^QTP_Master_1  | Condition ID:^CDFNDCON13    | Name:^Field NDC Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFNDCON13 | Name:^Field NDC Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | NDC Name is the same as 89754612315 | Single Field NDC Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View Single Field NDC Name Condition from Search Results table using Master Customer Set, Type and Sub-status
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Sub_Status     | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status         | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description          | Notes                      | Tags          |
      | QTP_Master_1        | Single |              |      | Ready for Use |        |       |                      |      | Not Associated |      |                          |                             | View      | CDFNDCON13        | Master customer set:^QTP_Master_1  | Condition ID:^CDFNDCON13    | Name:^Field NDC Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFNDCON13 | Name:^Field NDC Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | NDC Name is the same as 89754612315 | Single Field NDC Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View Single Field NDC Name Condition using Condition ID and Sub-status
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Sub_Status     | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status         | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description          | Notes                      | Tags          |
      | QTP_Master_1        | Single | FNDCON13     |      | Ready for Use |        |       |                      |      | Not Associated |      |                          |                             |           |                   | Master customer set:^QTP_Master_1  | Condition ID:^CDFNDCON13    | Name:^Field NDC Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFNDCON13 | Name:^Field NDC Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | NDC Name is the same as 89754612315 | Single Field NDC Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View Single Field NDC Name Condition using Condition Name and Sub-status
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name                  | Status        | Source | Field | Benefit_Customer_Set | List | Sub_Status     | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status         | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description          | Notes                      | Tags          |
      | QTP_Master_1        | Single |              | Field NDC Condition13 | Ready for Use |        |       |                      |      | Not Associated |      |                          |                             |           |                   | Master customer set:^QTP_Master_1  | Condition ID:^CDFNDCON13    | Name:^Field NDC Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFNDCON13 | Name:^Field NDC Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | NDC Name is the same as 89754612315 | Single Field NDC Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View Single Field NDC Name Condition using Condition ID, Sub-status and Source details
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status        | Source | Field    | Benefit_Customer_Set | List | Sub_Status     | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status         | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description          | Notes                      | Tags          |
      | QTP_Master_1        | Single | FNDCON13     |      | Ready for Use | Field  | NDC Name |                      |      | Not Associated |      |                          |                             |           |                   | Master customer set:^QTP_Master_1  | Condition ID:^CDFNDCON13    | Name:^Field NDC Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFNDCON13 | Name:^Field NDC Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | NDC Name is the same as 89754612315 | Single Field NDC Condition | Tag Name^tag1 |
  ...
  #Examples:
  #| Master_Customer_Set | Type   | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Sub_Status     | Tags     | Tags_Add_Success_Message                 | Tags_Remove_Success_Message                           | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status         | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description          | Notes                      | Tags          |
  #| QTP_Master_1        | Single | FNDCON13     |      | Ready for Use |        |       |                      |      | Not Associated | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. |           |                   | Master customer set:^QTP_Master_1  | Condition ID:^CDFNDCON13    | Name:^Field NDC Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFNDCON13 | Name:^Field NDC Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | NDC Name is the same as 89754612315 | Single Field NDC Condition | Tag Name^tag1 |
  Scenario Outline: Wildcard search using Condition ID and View Single Field NDC Name Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Sub_Status | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status         | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description          | Notes                      | Tags          |
      | QTP_Master_1        | Single | *CON*        |      | Ready for Use |        |       |                      |      |            |      |                          |                             | View      | CDFNDCON13        | Master customer set:^QTP_Master_1  | Condition ID:^CDFNDCON13    | Name:^Field NDC Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFNDCON13 | Name:^Field NDC Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | NDC Name is the same as 89754612315 | Single Field NDC Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Wildcard search using Condition Name and View Single Field NDC Name Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name        | Status        | Source | Field | Benefit_Customer_Set | List | Sub_Status | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status         | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description          | Notes                      | Tags          |
      | QTP_Master_1        | Single |              | *Condition* | Ready for Use |        |       |                      |      |            |      |                          |                             | View      | CDFNDCON13        | Master customer set:^QTP_Master_1  | Condition ID:^CDFNDCON13    | Name:^Field NDC Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFNDCON13 | Name:^Field NDC Condition13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | NDC Name is the same as 89754612315 | Single Field NDC Condition | Tag Name^tag1 |
...
Scenario Outline: Copy Single Field NDC Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FNDCON13      |      | Ready for Use |        |       |                      |      | FNDCPY13           | Field NDC Condition Copy13 | Ready for Use | Test TrackingID |             |            | The condition was successfully copied. |
 ...
 Scenario Outline: View the Copied Single Field NDC Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name             | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID     | Header_Name                     | Header_Status         | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description          | Notes                      | Tags          |
      | QTP_Master_1        | Single | FNDCPY13      |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFNDCPY13     | Name:^Field NDC Condition Copy13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFNDCPY13 | Name:^Field NDC Condition Copy13 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | NDC Name is the same as 89754612315 | Single Field NDC Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Single Single Field NDC Name Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FNDCON13     |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
	  | QTP_Master_1        | Single | FNDCPY13      |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |