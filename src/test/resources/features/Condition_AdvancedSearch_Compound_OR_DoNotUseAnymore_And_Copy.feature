...
Feature: Advanced Search Compound Condition with OR operator and Do Not Use Anymore status And Copy the Condition
  ...
  Scenario Outline: Delete the created conditions
  	...
  	Examples:
  		| Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
  		| QTP_Master_1        | Compound | CMPCON24     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  		| QTP_Master_1        | Compound | CMPCPY24      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Compound Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | CMPCON24     | Compound Condition24 | Do Not Use Anymore | Compound | OR                | Add^TPCOND29^TPCOND30 | Compound Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: Search and View Compound Condition from Search Results table using Master Customer Set
    ...
    Examples: 
       ...
       | QTP_Master_1        |      | Do Not Use Anymore | View      | CDCMPCON24   | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON24    | Name:^Compound Condition24 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON24 | Name:^Compound Condition24 | Status:^Do Not Use Anymore | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND29 | Name^TPCOND29        | Condition ID^CDTPCOND30 | Name^TPCOND30        | CDCMPCON1: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON1: Compound Condition1     | CDTPCOND29: COMPOUND CODE is the same as 1^OR^CDTPCOND30: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Search and View Compound Condition from Search Results table using Master Customer Set and Type
    ...
    Examples: 
      | Master_Customer_Set | Type     | Status             | Operation | Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name        | Header_Summary_Status      | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                | Header_Status              | Header_Type    | View_Compound_Operator | View_Condition_ID1      | View_Condition_Name1 | View_Condition_ID2      | View_Condition_Name2 | View_Condition_Description                                                             | View_Condition_Details_Description | View_Condition_Details                                                                            | Notes              | Tags          |
      | QTP_Master_1        | Compound | Do Not Use Anymore | View      | CDCMPCON24   | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON24    | Name:^Compound Condition24 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON24 | Name:^Compound Condition24 | Status:^Do Not Use Anymore | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND29 | Name^TPCOND29        | Condition ID^CDTPCOND30 | Name^TPCOND30        | CDCMPCON1: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON1: Compound Condition1     | CDTPCOND29: COMPOUND CODE is the same as 1^OR^CDTPCOND30: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Search and View Compound Condition using Condition ID
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCON24     |      | Do Not Use Anymore |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON24    | Name:^Compound Condition24 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON24 | Name:^Compound Condition24 | Status:^Do Not Use Anymore | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND29 | Name^TPCOND29        | Condition ID^CDTPCOND30 | Name^TPCOND30        | CDCMPCON1: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON1: Compound Condition1     | CDTPCOND29: COMPOUND CODE is the same as 1^OR^CDTPCOND30: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Search and View Compound Condition using Condition ID and Source details
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status             | Source | Field         | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name        | Header_Summary_Status      | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                | Header_Status              | Header_Type    | View_Compound_Operator | View_Condition_ID1      | View_Condition_Name1 | View_Condition_ID2      | View_Condition_Name2 | View_Condition_Description                                                             | View_Condition_Details_Description | View_Condition_Details                                                                            | Notes              | Tags          |
      | QTP_Master_1        | Compound | CMPCON24     |      | Do Not Use Anymore | Field  | COMPOUND CODE |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON24    | Name:^Compound Condition24 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON24 | Name:^Compound Condition24 | Status:^Do Not Use Anymore | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND29 | Name^TPCOND29        | Condition ID^CDTPCOND30 | Name^TPCOND30        | CDCMPCON1: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON1: Compound Condition1     | CDTPCOND29: COMPOUND CODE is the same as 1^OR^CDTPCOND30: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View Compound Condition from Search Results table using Master Customer Set and Sub-status
    ...
    Examples: 
      ...
      | QTP_Master_1        |      |              |      | Do Not Use Anymore |        |       |                      |      | Not Associated |      |                          |                             | View      | CDCMPCON24        | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON24    | Name:^Compound Condition24 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON24 | Name:^Compound Condition24 | Status:^Do Not Use Anymore | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND29 | Name^TPCOND29        | Condition ID^CDTPCOND30 | Name^TPCOND30        | CDCMPCON1: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON1: Compound Condition1     | CDTPCOND29: COMPOUND CODE is the same as 1^OR^CDTPCOND30: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View Compound Condition from Search Results table using Master Customer Set, Type and Sub-status
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status             | Source | Field | Benefit_Customer_Set | List | Sub_Status     | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name        | Header_Summary_Status      | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                | Header_Status              | Header_Type    | View_Compound_Operator | View_Condition_ID1      | View_Condition_Name1 | View_Condition_ID2      | View_Condition_Name2 | View_Condition_Description                                                             | View_Condition_Details_Description | View_Condition_Details                                                                            | Notes              | Tags          |
      | QTP_Master_1        | Compound |              |      | Do Not Use Anymore |        |       |                      |      | Not Associated |      |                          |                             | View      | CDCMPCON24        | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON24    | Name:^Compound Condition24 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON24 | Name:^Compound Condition24 | Status:^Do Not Use Anymore | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND29 | Name^TPCOND29        | Condition ID^CDTPCOND30 | Name^TPCOND30        | CDCMPCON1: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON1: Compound Condition1     | CDTPCOND29: COMPOUND CODE is the same as 1^OR^CDTPCOND30: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View Compound Condition using Condition ID and Sub-status
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status             | Source | Field | Benefit_Customer_Set | List | Sub_Status     | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name        | Header_Summary_Status      | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                | Header_Status              | Header_Type    | View_Compound_Operator | View_Condition_ID1      | View_Condition_Name1 | View_Condition_ID2      | View_Condition_Name2 | View_Condition_Description                                                             | View_Condition_Details_Description | View_Condition_Details                                                                            | Notes              | Tags          |
      | QTP_Master_1        | Compound | CMPCON24     |      | Do Not Use Anymore |        |       |                      |      | Not Associated |      |                          |                             |           |                   | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON24    | Name:^Compound Condition24 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON24 | Name:^Compound Condition24 | Status:^Do Not Use Anymore | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND29 | Name^TPCOND29        | Condition ID^CDTPCOND30 | Name^TPCOND30        | CDCMPCON1: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON1: Compound Condition1     | CDTPCOND29: COMPOUND CODE is the same as 1^OR^CDTPCOND30: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View Compound Condition using Condition ID, Sub-status and Source details
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status             | Source | Field         | Benefit_Customer_Set | List | Sub_Status     | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name        | Header_Summary_Status      | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                | Header_Status              | Header_Type    | View_Compound_Operator | View_Condition_ID1      | View_Condition_Name1 | View_Condition_ID2      | View_Condition_Name2 | View_Condition_Description                                                             | View_Condition_Details_Description | View_Condition_Details                                                                            | Notes              | Tags          |
      | QTP_Master_1        | Compound | CMPCON24     |      | Do Not Use Anymore | Field  | COMPOUND CODE |                      |      | Not Associated |      |                          |                             |           |                   | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON24    | Name:^Compound Condition24 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON24 | Name:^Compound Condition24 | Status:^Do Not Use Anymore | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND29 | Name^TPCOND29        | Condition ID^CDTPCOND30 | Name^TPCOND30        | CDCMPCON1: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON1: Compound Condition1     | CDTPCOND29: COMPOUND CODE is the same as 1^OR^CDTPCOND30: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
 ...
 #Scenario Outline: Search and View Compound Condition using Condition ID, Sub status and Tags       ***** This Search condition is commented due to application issue with Tags *****
    ...
    #Examples: 
      #| Master_Customer_Set | Type     | Condition_ID | Name | Status             | Source | Field | Benefit_Customer_Set | List | Sub_Status     | Tags     | Tags_Add_Success_Message                 | Tags_Remove_Success_Message                           | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name        | Header_Summary_Status      | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                | Header_Status              | Header_Type    | View_Compound_Operator | View_Condition_ID1      | View_Condition_Name1 | View_Condition_ID2      | View_Condition_Name2 | View_Condition_Description                                                             | View_Condition_Details_Description | View_Condition_Details                                                                            | Notes              | Tags          |
      #| QTP_Master_1        | Compound | CMPCON24     |      | Do Not Use Anymore |        |       |                      |      | Not Associated | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. |           |                   | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON24    | Name:^Compound Condition24 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON24 | Name:^Compound Condition24 | Status:^Do Not Use Anymore | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND29 | Name^TPCOND29        | Condition ID^CDTPCOND30 | Name^TPCOND30        | CDCMPCON1: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON1: Compound Condition1     | CDTPCOND29: COMPOUND CODE is the same as 1^OR^CDTPCOND30: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Wildcard search using Condition ID and View Compound Condition
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status             | Source | Field | Benefit_Customer_Set | List | Sub_Status | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name        | Header_Summary_Status      | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                | Header_Status              | Header_Type    | View_Compound_Operator | View_Condition_ID1      | View_Condition_Name1 | View_Condition_ID2      | View_Condition_Name2 | View_Condition_Description                                                             | View_Condition_Details_Description | View_Condition_Details                                                                            | Notes              | Tags          |
      | QTP_Master_1        | Compound | *CON*        |      | Do Not Use Anymore |        |       |                      |      |            |      |                          |                             | View      | CDCMPCON24        | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON24    | Name:^Compound Condition24 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON24 | Name:^Compound Condition24 | Status:^Do Not Use Anymore | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND29 | Name^TPCOND29        | Condition ID^CDTPCOND30 | Name^TPCOND30        | CDCMPCON1: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON1: Compound Condition1     | CDTPCOND29: COMPOUND CODE is the same as 1^OR^CDTPCOND30: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Wildcard search using Condition Name and View Compound Condition
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name        | Status             | Source | Field | Benefit_Customer_Set | List | Sub_Status | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name        | Header_Summary_Status      | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                | Header_Status              | Header_Type    | View_Compound_Operator | View_Condition_ID1      | View_Condition_Name1 | View_Condition_ID2      | View_Condition_Name2 | View_Condition_Description                                                             | View_Condition_Details_Description | View_Condition_Details                                                                            | Notes              | Tags          |
      | QTP_Master_1        | Compound |              | *Condition* | Do Not Use Anymore |        |       |                      |      |            |      |                          |                             | View      | CDCMPCON24        | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON24    | Name:^Compound Condition24 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON24 | Name:^Compound Condition24 | Status:^Do Not Use Anymore | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND29 | Name^TPCOND29        | Condition ID^CDTPCOND30 | Name^TPCOND30        | CDCMPCON1: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON1: Compound Condition1     | CDTPCOND29: COMPOUND CODE is the same as 1^OR^CDTPCOND30: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Copy Compound OR Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCON24      |      | Do Not Use Anymore |        |       |                      |      | CMPCPY24           | Compound Condition Copy24 | Do Not Use Anymore | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Compound OR Condition
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status             | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name            | Header_Summary_Status      | Header_Master_Customer_Set        | Header_Condition_ID     | Header_Name                    | Header_Status              | Header_Type    | View_Compound_Operator | View_Condition_ID1      | View_Condition_Name1 | View_Condition_ID2      | View_Condition_Name2 | View_Condition_Description                                                             | View_Condition_Details_Description  | View_Condition_Details                                                                            | Notes              | Tags          |
      | QTP_Master_1        | Compound | CMPCPY24      |      | Do Not Use Anymore |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCPY24     | Name:^Compound Condition Copy24 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCPY24 | Name:^Compound Condition Copy24 | Status:^Do Not Use Anymore | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND17 | Name^TPCOND17        | Condition ID^CDTPCOND18 | Name^TPCOND18        | CDCMPCPY24: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCPY24: Compound Condition Copy24 | CDTPCOND17: COMPOUND CODE is the same as 1^OR^CDTPCOND18: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Compound Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCON24     |      | Do Not Use Anymore |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
      | QTP_Master_1        | Compound | CMPCPY24      |      | Do Not Use Anymore |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |    
