Feature: Copy Compound Condition with AND operator and Ready for Use status
  ...
  Scenario Outline: Delete the created conditions
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Compound | CMPCPY13     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
      | QTP_Master_1        | Compound | CMPCON13     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Compound Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | CMPCON13     | Compound Condition13 | Ready for Use | Compound | AND               | Add^TPCOND13^TPCOND14 | Compound Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: Copy Compound AND Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCON13     |      | Ready for Use |        |       |                      |      | CMPCPY13          | Compound Condition Copy13 | Ready for Use | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Compound AND Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCPY13     |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCPY13    | Name:^Compound Condition Copy13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCPY13 | Name:^Compound Condition Copy13 | Status:^Ready for Use | Type:^Compound | Compound operator:^AND | Condition ID^CDTPCOND13 | Name^TPCOND13        | Condition ID^CDTPCOND14 | Name^TPCOND14        | CDCMPCPY13: (COMPOUND CODE is the same as 1 AND NDC Name is not the same as 18860067870) | CDCMPCPY13: Compound Condition Copy13 | CDTPCOND13: COMPOUND CODE is the same as 1^AND^CDTPCOND14: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Compound Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCPY13     |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
      | QTP_Master_1        | Compound | CMPCON13     |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |