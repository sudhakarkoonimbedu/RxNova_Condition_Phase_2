...
Feature: Advanced Search Compound Condition with AND operator and Ready for Use status And Copy the Condition
  ...
  Scenario Outline: Delete the created conditions
  	...
  	Examples:
  		...
  		| QTP_Master_1        | Compound | CMPCPY19     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
 ...
 #Scenario Outline: Search and View Compound Condition using Condition ID, Sub status and Tags       ***** This Search condition is commented due to application issue with Tags *****
  ...
  Scenario Outline: Copy Compound AND Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCON19     |      | Ready for Use |        |       |                      |      | CMPCPY19          | Compound Condition Copy19 | Ready for Use | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Compound AND Condition
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name             | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                     | Header_Status         | Header_Type    | View_Compound_Operator | View_Condition_ID1      | View_Condition_Name1 | View_Condition_ID2      | View_Condition_Name2 | View_Condition_Description                                                               | View_Condition_Details_Description    | View_Condition_Details                                                                             | Notes              | Tags          |
      | QTP_Master_1        | Compound | CMPCPY19     |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCPY19    | Name:^Compound Condition Copy19 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCPY19 | Name:^Compound Condition Copy19 | Status:^Ready for Use | Type:^Compound | Compound operator:^AND | Condition ID^CDTPCOND13 | Name^TPCOND13        | Condition ID^CDTPCOND14 | Name^TPCOND14        | CDCMPCPY19: (COMPOUND CODE is the same as 1 AND NDC Name is not the same as 18860067870) | CDCMPCPY19: Compound Condition Copy19 | CDTPCOND13: COMPOUND CODE is the same as 1^AND^CDTPCOND14: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Compound Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCPY19     |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |    
