...
Scenario Outline: Delete the created conditions 
	...
	Examples: 
		...
		| QTP_Master_1        | Single | FNDCPY15      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
...
Scenario Outline: Add the Single Field NDC Name Condition 
	...
	Examples: 
		...
		| Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | FNDCON15     | Field NDC Condition15 | Do Not Use Anymore | Single | Field  | NDC Name   | Is the Same As | 89754612915 |                      |          |       | Single Field NDC Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
...
Scenario Outline: Copy Single Field NDC Condition 
	...
	Examples: 
		...
		| QTP_Master_1        | Single | FNDCON15      |      | Do Not Use Anymore |        |       |                      |      | FNDCPY15           | Field NDC Condition Copy15 | Do Not Use Anymore | Test TrackingID |             |            | The condition was successfully copied. |
...
Scenario Outline: View the Copied Single Field NDC Condition 
	...
	Examples: 
		| Master_Customer_Set | Type   | Condition_ID | Name | Status             | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name             | Header_Summary_Status      | Header_Master_Customer_Set        | Header_Condition_ID     | Header_Name                     | Header_Status              | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description          | Notes                      | Tags          |
		| QTP_Master_1        | Single | FNDCPY15      |      | Do Not Use Anymore |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFNDCPY15     | Name:^Field NDC Condition Copy15 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDFNDCPY15 | Name:^Field NDC Condition Copy15 | Status:^Do Not Use Anymore | Type:^Single | Source:^Field |                           | NDC Name is the same as 89754612915 | Single Field NDC Condition | Tag Name^tag1 |
...
Scenario Outline: Delete the Single Single Field NDC Name Condition 
	...
	Examples: 
		...
		| QTP_Master_1        | Single | FNDCPY15      |      | Do Not Use Anymore |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |    
