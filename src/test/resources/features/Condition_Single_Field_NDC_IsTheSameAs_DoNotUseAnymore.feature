...
Feature: Single Field NDC Name Condition with Is the Same As operator and Do Not Use Anymore status
  ...
  Scenario Outline: Add the Single Field NDC Name Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | FNDCON3      | Field NDC Condition3 | Do Not Use Anymore | Single | Field  | NDC Name   | Is the Same As | 89954612315 |                      |          |           | Single Field NDC Condition3 | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: Update the Single Field NDC Name Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FNDCON3      |       | Do Not Use Anymore |           |       |                      |      | Update Tracking ID | Update Test Reason | Update Test Notes | Update Field NDC Condition3 | Do Not Use Anymore | Field         | NDC Name          | Is the Same As        | 89954612315        |                  |              | Update Single Field NDC Condition3 | Remove^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully saved. | 
  ...
  Scenario Outline: View the Single Field NDC Name Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status             | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name               | Header_Summary_Status      | Header_Master_Customer_Set        | Header_Condition_ID     | Header_Name                       | Header_Status              | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description          | Notes                              | Tags |
      | QTP_Master_1        | Single | FNDCON3      |      | Do Not Use Anymore |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFNDCON3     | Name:^Update Field NDC Condition3 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDFNDCON3 | Name:^Update Field NDC Condition3 | Status:^Do Not Use Anymore | Type:^Single | Source:^Field |                           | NDC Name is the same as 89954612315 | Update Single Field NDC Condition3 |      |
