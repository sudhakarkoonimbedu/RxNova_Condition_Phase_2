...
Feature: Copy Single Drug List Condition with Not Ready status from Search Results table
  ...
  Scenario Outline: Delete the created conditions
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Single | DRGCPY11     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
      | QTP_Master_1        | Single | DRGCON11     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single DrugList Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | DRGCON11     | Drug List Condition11 | Not Ready | Single | Drug List |            |                |             | QTP_Benefits         | Is Not Included In | FLTPDLI5 | Single Drug List Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: Copy Single DrugList Condition from Search Results table
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | Not Ready | Copy      | CDDRGCON11   | DRGCPY11          | Drug List Condition Copy11 | Not Ready   | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Single DrugList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | DRGCPY11     |      | Not Ready |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDDRGCPY11    | Name:^Drug List Condition Copy11 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDDRGCPY11 | Name:^Drug List Condition Copy11 | Status:^Not Ready | Type:^Single | Source:^Drug List | Benefit customer set:^QTP_Benefits | Drug is not included in drug list FLTPDLI5 | Single Drug List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Single DrugList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | DRGCPY11     |      | Not Ready |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
      | QTP_Master_1        | Single | DRGCON11     |      | Not Ready |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
