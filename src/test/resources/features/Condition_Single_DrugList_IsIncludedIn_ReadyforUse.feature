...
Feature: Single Drug List Condition with Is Included In operator and Ready for Use status
  ...
  Scenario Outline: Delete the created condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID  | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Single | DRGCOND4      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single DrugList Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | DRGCOND4      | Drug List Condition4 | Ready for Use | Single | Drug List |            |                |             | QTP_Benefits         | Is Included In | FLTPDLI1 | Single Drug List Condition4 | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: View the Single DrugList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | DRGCOND4      |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDDRGCOND4     | Name:^Drug List Condition4 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDDRGCOND4 | Name:^Drug List Condition4 | Status:^Ready for Use | Type:^Single | Source:^Drug List | Benefit customer set:^QTP_Benefits | Drug is not included in drug list FLTPDLI1 | Single Drug List Condition4 | Tag Name^tag1 |
  ...
  Scenario Outline: Update the Single DrugList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | DRGCOND4     |       | Ready for Use |           |       |                      |      | Update Tracking ID | Update Test Reason | Update Test Notes | Update Drug List Condition4 | Ready for Use | Drug List     |                   |                       |                    | Is Included In  | FLTPDLI1     | Update Single Drug List Condition4 | Remove^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully saved. | 
  ...
  Scenario Outline: View the Single DrugList Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name               | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                       | Header_Status         | Header_Type  | View_Source       | View_Benefit_Customer_Set          | View_Condition_Description                 | Notes                              | Tags |
      | QTP_Master_1        | Single | DRGCOND4     |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDDRGCOND4    | Name:^Update Drug List Condition4 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDDRGCOND4 | Name:^Update Drug List Condition4 | Status:^Ready for Use | Type:^Single | Source:^Drug List | Benefit customer set:^QTP_Benefits | Drug is not included in drug list FLTPDLI1 | Update Single Drug List Condition4 |      |
  ...
  Scenario Outline: Delete the Single DrugList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | DRGCOND4     |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |