Feature: Advanced Search Single Drug List Condition with Not Ready status And Copy the Condition
  ...
  Scenario Outline: Delete the created conditions
  	...
  	Examples:
  		| Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
  		| QTP_Master_1        | Single | DRGCON14     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  		| QTP_Master_1        | Single | DRGCPY14      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single DrugList Condition
  	...
  	Examples:
  		...
  		| Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | DRGCON14     | Drug List Condition14 | Not Ready | Single | Drug List |            |                |             | QTP_Benefits         | Is Not Included In | FLTPDLI8 | Single Drug List Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: Search and View DrugList Condition from Search Results table using Master Customer Set
    ...
    Examples: 
      ...
      | QTP_Master_1        |      | Not Ready | View      | CDDRGCON14   | Master customer set:^QTP_Master_1  | Condition ID:^CDDRGCON14    | Name:^Drug List Condition14 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDDRGCON14 | Name:^Drug List Condition14 | Status:^Not Ready | Type:^Single | Source:^Drug List | Benefit customer set:^QTP_Benefits | Drug is not included in drug list FLTPDLI8 | Single Drug List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Search and View DrugList Condition from Search Results table using Master Customer Set and Type
    ...
    Examples: 
      | Master_Customer_Set | Type   | Status    | Operation | Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status     | Header_Type  | View_Source       | View_Benefit_Customer_Set          | View_Condition_Description                 | Notes                      | Tags          |
      | QTP_Master_1        | Single | Not Ready | View      | CDDRGCON14   | Master customer set:^QTP_Master_1  | Condition ID:^CDDRGCON14    | Name:^Drug List Condition14 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDDRGCON14 | Name:^Drug List Condition14 | Status:^Not Ready | Type:^Single | Source:^Drug List | Benefit customer set:^QTP_Benefits | Drug is not included in drug list FLTPDLI8 | Single Drug List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Search and View DrugList Condition using Condition ID
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | DRGCON14     |      | Not Ready |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDDRGCON14    | Name:^Drug List Condition14 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDDRGCON14 | Name:^Drug List Condition14 | Status:^Not Ready | Type:^Single | Source:^Drug List | Benefit customer set:^QTP_Benefits | Drug is not included in drug list FLTPDLI8 | Single Drug List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Search and View DrugList Condition using Condition Name
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name                  | Status    | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status     | Header_Type  | View_Source       | View_Benefit_Customer_Set          | View_Condition_Description                 | Notes                      | Tags          |
      | QTP_Master_1        | Single |              | Drug List Condition14 | Not Ready |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDDRGCON14    | Name:^Drug List Condition14 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDDRGCON14 | Name:^Drug List Condition14 | Status:^Not Ready | Type:^Single | Source:^Drug List | Benefit customer set:^QTP_Benefits | Drug is not included in drug list FLTPDLI8 | Single Drug List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Search and View DrugList Condition using Condition ID and Source details
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status    | Source    | Field | Benefit_Customer_Set | List     | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status     | Header_Type  | View_Source       | View_Benefit_Customer_Set          | View_Condition_Description                 | Notes                      | Tags          |
      | QTP_Master_1        | Single | DRGCON14     |      | Not Ready | Drug List |       | QTP_Benefits         | FLTPDLI8 | Master customer set:^QTP_Master_1  | Condition ID:^CDDRGCON14    | Name:^Drug List Condition14 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDDRGCON14 | Name:^Drug List Condition14 | Status:^Not Ready | Type:^Single | Source:^Drug List | Benefit customer set:^QTP_Benefits | Drug is not included in drug list FLTPDLI8 | Single Drug List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View DrugList Condition from Search Results table using Master Customer Set and Sub-status
    ...
    Examples: 
      ...
      | QTP_Master_1        |      |              |      | Not Ready |        |       |                      |      | Not Associated |      |                          |                             | View      | CDDRGCON14        | Master customer set:^QTP_Master_1  | Condition ID:^CDDRGCON14    | Name:^Drug List Condition14 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDDRGCON14 | Name:^Drug List Condition14 | Status:^Not Ready | Type:^Single | Source:^Drug List | Benefit customer set:^QTP_Benefits | Drug is not included in drug list FLTPDLI8 | Single Drug List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View DrugList Condition from Search Results table using Master Customer Set, Type and Sub-status
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status    | Source | Field | Benefit_Customer_Set | List | Sub_Status     | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status     | Header_Type  | View_Source       | View_Benefit_Customer_Set          | View_Condition_Description                 | Notes                      | Tags          |
      | QTP_Master_1        | Single |              |      | Not Ready |        |       |                      |      | Not Associated |      |                          |                             | View      | CDDRGCON14        | Master customer set:^QTP_Master_1  | Condition ID:^CDDRGCON14    | Name:^Drug List Condition14 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDDRGCON14 | Name:^Drug List Condition14 | Status:^Not Ready | Type:^Single | Source:^Drug List | Benefit customer set:^QTP_Benefits | Drug is not included in drug list FLTPDLI8 | Single Drug List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View DrugList Condition using Condition ID and Sub-status
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status    | Source | Field | Benefit_Customer_Set | List | Sub_Status     | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status     | Header_Type  | View_Source       | View_Benefit_Customer_Set          | View_Condition_Description                 | Notes                      | Tags          |
      | QTP_Master_1        | Single | DRGCON14     |      | Not Ready |        |       |                      |      | Not Associated |      |                          |                             |           |                   | Master customer set:^QTP_Master_1  | Condition ID:^CDDRGCON14    | Name:^Drug List Condition14 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDDRGCON14 | Name:^Drug List Condition14 | Status:^Not Ready | Type:^Single | Source:^Drug List | Benefit customer set:^QTP_Benefits | Drug is not included in drug list FLTPDLI8 | Single Drug List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View DrugList Condition using Condition Name and Sub-status
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name                  | Status    | Source | Field | Benefit_Customer_Set | List | Sub_Status     | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID  | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status     | Header_Type  | View_Source       | View_Benefit_Customer_Set          | View_Condition_Description                 | Notes                      | Tags          |
      | QTP_Master_1        | Single |              | Drug List Condition14 | Not Ready |        |       |                      |      | Not Associated |      |                          |                             |           |                   | Master customer set:^QTP_Master_1  | Condition ID:^CDDRGCON14     | Name:^Drug List Condition14 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDDRGCON14 | Name:^Drug List Condition14 | Status:^Not Ready | Type:^Single | Source:^Drug List | Benefit customer set:^QTP_Benefits | Drug is not included in drug list FLTPDLI8 | Single Drug List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View DrugList Condition using Condition ID, Sub-status and Source details
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status    | Source    | Field | Benefit_Customer_Set | List     | Sub_Status     | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status     | Header_Type  | View_Source       | View_Benefit_Customer_Set          | View_Condition_Description                 | Notes                      | Tags          |
      | QTP_Master_1        | Single | DRGCON14     |      | Not Ready | Drug List |       | QTP_Benefits         | FLTPDLI8 | Not Associated |      |                          |                             |           |                   | Master customer set:^QTP_Master_1  | Condition ID:^CDDRGCON14    | Name:^Drug List Condition14 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDDRGCON14 | Name:^Drug List Condition14 | Status:^Not Ready | Type:^Single | Source:^Drug List | Benefit customer set:^QTP_Benefits | Drug is not included in drug list FLTPDLI8 | Single Drug List Condition | Tag Name^tag1 |
 ...
 #Scenario Outline: Search and View DrugList Condition using Condition ID, Sub status and Tags       ***** This Search condition is commented due to application issue with Tags *****
    ...
    #Examples: 
      #| Master_Customer_Set | Type   | Condition_ID | Name | Status    | Source | Field | Benefit_Customer_Set | List | Sub_Status     | Tags     | Tags_Add_Success_Message                 | Tags_Remove_Success_Message                           | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status     | Header_Type  | View_Source       | View_Benefit_Customer_Set          | View_Condition_Description                 | Notes                      | Tags          |
      #| QTP_Master_1        | Single | DRGCON14     |      | Not Ready |        |       |                      |      | Not Associated | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. |           |                   | Master customer set:^QTP_Master_1  | Condition ID:^CDDRGCON14    | Name:^Drug List Condition14 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDDRGCON14 | Name:^Drug List Condition14 | Status:^Not Ready | Type:^Single | Source:^Drug List | Benefit customer set:^QTP_Benefits | Drug is not included in drug list FLTPDLI8 | Single Drug List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Wildcard search using Condition ID and View DrugList Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status    | Source | Field | Benefit_Customer_Set | List | Sub_Status | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status     | Header_Type  | View_Source       | View_Benefit_Customer_Set          | View_Condition_Description                 | Notes                      | Tags          |
      | QTP_Master_1        | Single | *CON*        |      | Not Ready |        |       |                      |      |            |      |                          |                             | View      | CDDRGCON14        | Master customer set:^QTP_Master_1  | Condition ID:^CDDRGCON14    | Name:^Drug List Condition14 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDDRGCON14 | Name:^Drug List Condition14 | Status:^Not Ready | Type:^Single | Source:^Drug List | Benefit customer set:^QTP_Benefits | Drug is not included in drug list FLTPDLI8 | Single Drug List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Wildcard search using Condition Name and View DrugList Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name        | Status    | Source | Field | Benefit_Customer_Set | List | Sub_Status | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name         | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                 | Header_Status     | Header_Type  | View_Source       | View_Benefit_Customer_Set          | View_Condition_Description                 | Notes                      | Tags          |
      | QTP_Master_1        | Single |              | *Condition* | Not Ready |        |       |                      |      |            |      |                          |                             | View      | CDDRGCON14        | Master customer set:^QTP_Master_1  | Condition ID:^CDDRGCON14    | Name:^Drug List Condition14 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDDRGCON14 | Name:^Drug List Condition14 | Status:^Not Ready | Type:^Single | Source:^Drug List | Benefit customer set:^QTP_Benefits | Drug is not included in drug list FLTPDLI8 | Single Drug List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Copy Single DrugList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | DRGCON14      |      | Not Ready |        |       |                      |      | DRGCPY14           | Drug List Condition Copy14 | Not Ready   | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Single DrugList Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status    | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name             | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID     | Header_Name                     | Header_Status     | Header_Type  | View_Source       | View_Benefit_Customer_Set          | View_Condition_Description             | Notes                      | Tags          |
      | QTP_Master_1        | Single | DRGCPY14      |      | Not Ready |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDDRGCPY14     | Name:^Drug List Condition Copy14 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDDRGCPY14 | Name:^Drug List Condition Copy14 | Status:^Not Ready | Type:^Single | Source:^Drug List | Benefit customer set:^QTP_Benefits | Drug is included in drug list FLTPDLI5 | Single Drug List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Single DrugList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | DRGCON14     |      | Not Ready |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
      | QTP_Master_1        | Single | DRGCPY14      |      | Not Ready |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |    
