Feature: Copy Single Drug List Condition with Do Not Use Anymore status
  ...
  Scenario Outline: Delete the created conditions
  	...
  	Examples:
  		...
  		| QTP_Master_1        | Single | DRGCON9      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single DrugList Condition
  	...
  	Examples:
  		...
  		| Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | DRGCON9      | Drug List Condition9 | Do Not Use Anymore | Single | Drug List |            |                |             | QTP_Benefits         | Is Included In | FLTPDLI6 | Single Drug List Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: Copy Single DrugList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | DRGCON9      |      | Do Not Use Anymore |        |       |                      |      | DRGCPY9           | Drug List Condition Copy9 | Do Not Use Anymore | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Single DrugList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | DRGCPY9      |      | Do Not Use Anymore |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDDRGCPY9     | Name:^Drug List Condition Copy9 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDDRGCPY9 | Name:^Drug List Condition Copy9 | Status:^Do Not Use Anymore | Type:^Single | Source:^Drug List | Benefit customer set:^QTP_Benefits | Drug is included in drug list FLTPDLI6 | Single Drug List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Single DrugList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | DRGCPY9      |      | Do Not Use Anymore |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
      | QTP_Master_1        | Single | DRGCON9      |      | Do Not Use Anymore |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
