...
Feature: Single Field City Group Condition with Is Not the Same As operator and Do Not Use Anymore status
  ...
  Scenario Outline: Delete the created condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Single | FCGCON6      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  
  Scenario Outline: Add the Single Field City Group Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | FCGCON6      | Field CGP Condition6 | Do Not Use Anymore | Single | Field  | CITY - GROUP | Is Not the Same As | MISSOURI    |                      |          |       | Single Field Custom Group Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |

  Scenario Outline: View the Single Field City Group Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FCGCON6      |      | Do Not Use Anymore |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFCGCON6     | Name:^Field CGP Condition6 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDFCGCON6 | Name:^Field CGP Condition6 | Status:^Do Not Use Anymore | Type:^Single | Source:^Field |                           | CITY - GROUP is not the same as MISSOURI | Single Field Custom Group Condition | Tag Name^tag1 |
  
  Scenario Outline: Update the Single Field City Group Condition
    Given User search for the existing condition with the following details
      | Master_Customer_Set   | Type   | Condition_ID   | Name   | Status   | Source   | Field   | Benefit_Customer_Set   | List   |  
      | <Master_Customer_Set> | <Type> | <Condition_ID> | <Name> | <Status> | <Source> | <Field> | <Benefit_Customer_Set> | <List> |
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FCGCON6      |      | Do Not Use Anymore |           |       |                      |      | Update Tracking ID | Update Test Reason | Update Test Notes | Update Field CGP Condition6 | Do Not Use Anymore | Field         | CITY - GROUP      | Is Not the Same As    | MISSOURI           |                 |              | Update Single Field Custom Group Condition | Remove^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully saved. | 
  ...
  Scenario Outline: View the Single Field City Group Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status             | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name               | Header_Summary_Status      | Header_Master_Customer_Set        | Header_Condition_ID     | Header_Name                       | Header_Status              | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description               | Notes                                      | Tags |
      | QTP_Master_1        | Single | FCGCON6      |      | Do Not Use Anymore |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFCGCON6     | Name:^Update Field CGP Condition6 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDFCGCON6 | Name:^Update Field CGP Condition6 | Status:^Do Not Use Anymore | Type:^Single | Source:^Field |                           | CITY - GROUP is not the same as MISSOURI | Update Single Field Custom Group Condition |      |

  Scenario Outline: Delete the Single Field City Group Condition
    Given User search for the existing condition with the following details
      | Master_Customer_Set   | Type   | Condition_ID   | Name   | Status   | Source   | Field   | Benefit_Customer_Set   | List   |  
      | <Master_Customer_Set> | <Type> | <Condition_ID> | <Name> | <Status> | <Source> | <Field> | <Benefit_Customer_Set> | <List> |
    And verify the Condition Header tab and updates the Condition Header tab with the following details
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FCGCON6      |      | Do Not Use Anymore |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |