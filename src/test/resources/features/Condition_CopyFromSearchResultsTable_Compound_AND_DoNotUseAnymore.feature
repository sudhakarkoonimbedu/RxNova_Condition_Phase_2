Feature: Copy Compound Condition with AND operator and Do Not Use Anymore status from Search Results table
  ...
  Scenario Outline: Delete the created conditions
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Compound | CMPCPY18     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
      | QTP_Master_1        | Compound | CMPCON18     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Compound Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | CMPCON18     | Compound Condition18 | Do Not Use Anymore | Compound | AND               | Add^TPCOND23^TPCOND24 | Compound Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: Copy Single DrugList Condition from Search Results table
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | Do Not Use Anymore | Copy      | CDCMPCON18   | CMPCPY18          | Compound Condition Copy18 | Do Not Use Anymore | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Compound AND Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCPY18     |      | Do Not Use Anymore |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCPY18    | Name:^Compound Condition Copy18 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCPY18 | Name:^Compound Condition Copy18 | Status:^Do Not Use Anymore | Type:^Compound | Compound operator:^AND | Condition ID^CDTPCOND23 | Name^TPCOND23        | Condition ID^CDTPCOND24 | Name^TPCOND24        | CDCMPCPY18: (COMPOUND CODE is the same as 1 AND NDC Name is not the same as 18860067870) | CDCMPCPY18: Compound Condition Copy18 | CDTPCOND23: COMPOUND CODE is the same as 1^AND^CDTPCOND24: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Compound Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCPY18     |      | Do Not Use Anymore |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
      | QTP_Master_1        | Compound | CMPCON18     |      | Do Not Use Anymore |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |