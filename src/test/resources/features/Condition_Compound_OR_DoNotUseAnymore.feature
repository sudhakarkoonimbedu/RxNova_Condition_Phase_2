Feature: Compound Condition with OR operator and Do Not Use Anymore status
  ...
  Scenario Outline: Delete the created condition
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status      | Delete_Tracking_ID |
      | QTP_Master_1        | Compound | CMPCON6      |      |        | Update Tracking ID | Do Not Use Anymore | Delete Tracking ID |
  ...
  Scenario Outline: Add the Compound Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | CMPCON6      | Compound Condition6 | Do Not Use Anymore | Compound | OR                | Add^TPCOND9^TPCOND10  | Compound Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: View the Compound Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCON6      |      | Do Not Use Anymore |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON6     | Name:^Compound Condition6 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON6 | Name:^Compound Condition6 | Status:^Do Not Use Anymore | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND9 | Name^TPCOND9         | Condition ID^CDTPCOND10 | Name^TPCOND10        | CDCMPCON6: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCON6: Compound Condition6     | CDTPCOND9: COMPOUND CODE is the same as 1^OR^CDTPCOND10: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Update the Compound Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCON6      |      | Do Not Use Anymore |           |       |                      |      | Update Tracking ID | Update Test Reason | Update Test Notes | Update Compound Condition6 | Do Not Use Anymore | OR                       | Remove^CDTPCOND9^CDTPCOND10#Add^TPCOND11^TPCOND12 | Update Compound Condition | Remove^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully saved. | 
  ...
  Scenario Outline: View the Compound Condition
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status             | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name              | Header_Summary_Status      | Header_Master_Customer_Set        | Header_Condition_ID     | Header_Name                      | Header_Status              | Header_Type    | View_Compound_Operator | View_Condition_ID1      | View_Condition_Name1 | View_Condition_ID2      | View_Condition_Name2 | View_Condition_Description                                                              | View_Condition_Details_Description    | View_Condition_Details                                                                             | Notes                     | Tags |
      | QTP_Master_1        | Compound | CMPCON6      |      | Do Not Use Anymore |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON6     | Name:^Update Compound Condition6 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON6 | Name:^Update Compound Condition6 | Status:^Do Not Use Anymore | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND11 | Name^TPCOND11        | Condition ID^CDTPCOND12 | Name^TPCOND12        | CDCMPCON6: (NDC Name is the same as 18860067870 OR NDC Name is the same as 18860067870) | CDCMPCON6: Update Compound Condition6 | CDTPCOND11: NDC Name is the same as 18860067870^OR^CDTPCOND12: NDC Name is the same as 18860067870 | Update Compound Condition |      |
  ...
  Scenario Outline: Delete the Compound Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCON6      |      | Do Not Use Anymore |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |