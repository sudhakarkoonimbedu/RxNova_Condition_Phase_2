Feature: Copy Compound Condition with AND operator and Not Ready status
  ...
  Scenario Outline: Delete the created conditions
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Compound | CMPCPY14     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
      | QTP_Master_1        | Compound | CMPCON14     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Compound Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | CMPCON14     | Compound Condition14 | Not Ready | Compound | AND               | Add^TPCOND15^TPCOND16 | Compound Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: Copy Compound AND Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCON14     |      | Not Ready |        |       |                      |      | CMPCPY14          | Compound Condition Copy14 | Not Ready   | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Compound AND Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCPY14     |      | Not Ready |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCPY14    | Name:^Compound Condition Copy14 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCPY14 | Name:^Compound Condition Copy14 | Status:^Not Ready | Type:^Compound | Compound operator:^AND | Condition ID^CDTPCOND15 | Name^TPCOND15        | Condition ID^CDTPCOND16 | Name^TPCOND16        | CDCMPCPY14: (COMPOUND CODE is the same as 1 AND NDC Name is not the same as 18860067870) | CDCMPCPY14: Compound Condition Copy14 | CDTPCOND15: COMPOUND CODE is the same as 1^AND^CDTPCOND16: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Compound Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCPY14     |      | Not Ready |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
      | QTP_Master_1        | Compound | CMPCON14     |      | Not Ready |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |