...
Feature: Single Field City Group Condition with Is the Same As operator and Ready for Use status
  ...
  Scenario Outline: Delete the created condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Single | FCGCON1      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single Field City Group Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | FCGCON1      | Field CGP Condition1 | Ready for Use | Single | Field  | CITY - GROUP | Is the Same As | KANSAS      |                      |          |       | Single Field Custom Group Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: View the Single Field City Group Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FCGCON1      |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFCGCON1     | Name:^Field CGP Condition1 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFCGCON1 | Name:^Field CGP Condition1 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | CITY - GROUP is the same as KANSAS | Single Field Custom Group Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Update the Single Field City Group Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FCGCON1      |      | Ready for Use |           |       |                      |      | Update Tracking ID | Update Test Reason | Update Test Notes | Update Field CGP Condition1 | Ready for Use | Field         | CITY - GROUP      | Is the Same As        | KANSAS             |                 |              | Update Single Field Custom Group Condition | Remove^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully saved. | 
  ...
  Scenario Outline: View the Single Field City Group Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name               | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID     | Header_Name                       | Header_Status         | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description         | Notes                                      | Tags |
      | QTP_Master_1        | Single | FCGCON1      |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFCGCON1     | Name:^Update Field CGP Condition1 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFCGCON1 | Name:^Update Field CGP Condition1 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | CITY - GROUP is the same as KANSAS | Update Single Field Custom Group Condition |      |
  ...
  Scenario Outline: Delete the Single Field City Group Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FCGCON1      |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |