...
Feature: Single Drug List Condition2 with Is Not Included In operator and Not Ready status
  ...
  Scenario Outline: Delete the created condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Single | DRGCOND2     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single DrugList Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | DRGCOND2     | Drug List Condition2 | Not Ready | Single | Drug List |            |                |             | QTP_Benefits         | Is Not Included In | FLTPDLI2 | Single Drug List Condition2 | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: View the Single DrugList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | DRGCOND2     |      | Not Ready |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDDRGCOND2    | Name:^Drug List Condition2 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDDRGCOND2 | Name:^Drug List Condition2 | Status:^Not Ready | Type:^Single | Source:^Drug List | Benefit customer set:^QTP_Benefits | Drug is not included in drug list FLTPDLI2 | Single Drug List Condition2 | Tag Name^tag1 |
  ...
  Scenario Outline: Update the Single DrugList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | DRGCOND2     |       | Not Ready |           |       |                      |      | Update Tracking ID | Update Test Reason | Update Test Notes | Update Drug List Condition2 | Not Ready     | Drug List     |                   |                       |                    | Is Not Included In | FLTPDLI2     | Update Single Drug List Condition2 | Remove^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully saved. | 
  ...
  Scenario Outline: View the Single DrugList Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status    | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name               | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                       | Header_Status     | Header_Type  | View_Source       | View_Benefit_Customer_Set          | View_Condition_Description                 | Notes                              | Tags |
      | QTP_Master_1        | Single | DRGCOND2     |      | Not Ready |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDDRGCOND2    | Name:^Update Drug List Condition2 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDDRGCOND2 | Name:^Update Drug List Condition2 | Status:^Not Ready | Type:^Single | Source:^Drug List | Benefit customer set:^QTP_Benefits | Drug is not included in drug list FLTPDLI2 | Update Single Drug List Condition2 |      |
  ...
  Scenario Outline: Delete the Single DrugList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | DRGCOND2     |      | Not Ready |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |