...
Feature: Copy Single Pharmacy List Condition with Do Not Use Anymore status from Search Results table
  ...
  Scenario Outline: Delete the created conditions
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Single | PHRCPY12     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
      | QTP_Master_1        | Single | PHRCON12     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single PharmacyList Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | PHRCON12     | Pharmacy List Condition12 | Do Not Use Anymore | Single | Pharmacy List |            |                |             |                      | Is Not Included In | PTTPPHI6 | Single Pharmacy List Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |

  Scenario Outline: Copy Single PharmacyList Condition from Search Results table
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | Do Not Use Anymore | Copy      | CDPHRCON12   | PHRCPY12          | Pharmacy List Condition Copy12 | Do Not Use Anymore | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Single PharmacyList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | PHRCPY12     |      | Do Not Use Anymore |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDPHRCPY12    | Name:^Pharmacy List Condition Copy12 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDPHRCPY12 | Name:^Pharmacy List Condition Copy12 | Status:^Do Not Use Anymore | Type:^Single | Source:^Pharmacy List |                           | Pharmacy is not included in pharmacy list PTTPPHI6 | Single Pharmacy List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Single PharmacyList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | PHRCPY12     |      | Do Not Use Anymore |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
      | QTP_Master_1        | Single | PHRCON12     |      | Do Not Use Anymore |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
