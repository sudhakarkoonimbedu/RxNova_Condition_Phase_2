Feature: Advanced Search Single Field NDC Name Condition with Not Ready status
  ...
  Scenario Outline: Add the Single Field NDC Name Condition
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | FNDCON14     | Field NDC Condition14 | Not Ready | Single | Field  | NDC Name   | Is the Same As | 89754612315 |                      |          |       | Single Field NDC Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
