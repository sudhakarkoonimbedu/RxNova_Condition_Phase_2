Feature: Copy Single Field DEA Condition with Ready for Use status
  ...
  Scenario Outline: Delete the created conditions
  	...
  	Examples:
  		| Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
  		| QTP_Master_1        | Single | FDECPY7      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  		| QTP_Master_1        | Single | FDECON7      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single Field DEA Condition
  	...
  	Examples:
  		...
  		| Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | FDECON7      | Field DEA Condition7 | Ready for Use | Single | Field  | DEA CODE   | Includes       | A           |                      |          |       | Single Field DEA Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: Copy Single Field DEA Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FDECON7      |      | Ready for Use |        |       |                      |      | FDECPY7           | Field DEA Condition Copy7 | Ready for Use | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Single Field DEA Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FDECPY7      |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFDECPY7     | Name:^Field DEA Condition Copy7 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFDECPY7 | Name:^Field DEA Condition Copy7 | Status:^Ready for Use | Type:^Single | Source:^Field |                           | DEA CODE includes A        | Single Field DEA Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Single Field DEA Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FDECPY7      |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
      | QTP_Master_1        | Single | FDECON7      |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
