Feature: Copy Single Prescriber List Condition with Ready for Use status
  ...
  Scenario Outline: Delete the created conditions
  	...
  	Examples:
  		| Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
  		| QTP_Master_1        | Single | PRECPY7      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  		| QTP_Master_1        | Single | PRECON7      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single PrescriberList Condition
  	...
  	Examples:
  		...
  		| Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | PRECON7      | Prescriber List Condition7 | Ready for Use | Single | Prescriber List |            |                |             | QTP_Benefits         | Is Included In | PBTPPRI4 | Single Prescriber List Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: Copy Single PrescriberList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | PRECON7      |      | Ready for Use |        |       |                      |      | PRECPY7           | Prescriber List Condition Copy7 | Ready for Use | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Single PrescriberList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | PRECPY7      |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDPRECPY7     | Name:^Prescriber List Condition Copy7 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDPRECPY7 | Name:^Prescriber List Condition Copy7 | Status:^Ready for Use | Type:^Single | Source:^Prescriber List | Benefit customer set:^QTP_Benefits | Prescriber is included in prescriber list PBTPPRI4 | Single Prescriber List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Single PrescriberList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | PRECPY7      |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
      | QTP_Master_1        | Single | PRECON7      |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
