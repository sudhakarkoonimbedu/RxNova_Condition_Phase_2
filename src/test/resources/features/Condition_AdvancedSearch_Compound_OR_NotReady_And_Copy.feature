...
Feature: Advanced Search Compound Condition with OR operator and Not Ready status And Copy the Condition
  ...
  Scenario Outline: Delete the created conditions
  	...
  	Examples:
  		| Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
  		| QTP_Master_1        | Compound | CMPCON23     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  		| QTP_Master_1        | Compound | CMPCPY23      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
 ...
 #Scenario Outline: Search and View Compound Condition using Condition ID, Sub status and Tags       ***** This Search condition is commented due to application issue with Tags *****
  ...
  Scenario Outline: Copy Compound OR Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCON23      |      | Not Ready |        |       |                      |      | CMPCPY23           | Compound Condition Copy23 | Not Ready   | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Compound OR Condition
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status    | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name            | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID     | Header_Name                    | Header_Status     | Header_Type    | View_Compound_Operator | View_Condition_ID1      | View_Condition_Name1 | View_Condition_ID2      | View_Condition_Name2 | View_Condition_Description                                                             | View_Condition_Details_Description  | View_Condition_Details                                                                            | Notes              | Tags          |
      | QTP_Master_1        | Compound | CMPCPY23      |      | Not Ready |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCPY23     | Name:^Compound Condition Copy23 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCPY23 | Name:^Compound Condition Copy23 | Status:^Not Ready | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND15 | Name^TPCOND15        | Condition ID^CDTPCOND16 | Name^TPCOND16        | CDCMPCPY23: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCPY23: Compound Condition Copy23 | CDTPCOND15: COMPOUND CODE is the same as 1^OR^CDTPCOND16: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Compound Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCPY23      |      | Not Ready |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |    
