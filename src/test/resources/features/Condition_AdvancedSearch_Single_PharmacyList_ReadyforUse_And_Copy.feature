Feature: Advanced Search Single Pharmacy List Condition with Ready for Use status And Copy the Condition
  ...
  Scenario Outline: Add the Single PharmacyList Condition
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | PHRCON13     | Pharmacy List Condition13 | Ready for Use | Single | Pharmacy List |            |                |             |                      | Is Not Included In | PTTPPHI7 | Single Pharmacy List Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: Search and View PharmacyList Condition from Search Results table using Master Customer Set and Type
    ...
    Examples: 
      | Master_Customer_Set | Type   | Status        | Operation | Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name             | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                     | Header_Status         | Header_Type  | View_Source           | View_Benefit_Customer_Set | View_Condition_Description                         | Notes                          | Tags          |
      | QTP_Master_1        | Single | Ready for Use | View      | CDPHRCON13   | Master customer set:^QTP_Master_1  | Condition ID:^CDPHRCON13    | Name:^Pharmacy List Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDPHRCON13 | Name:^Pharmacy List Condition13 | Status:^Ready for Use | Type:^Single | Source:^Pharmacy List |                           | Pharmacy is not included in pharmacy list PTTPPHI7 | Single Pharmacy List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Search and View PharmacyList Condition using Condition ID
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | PHRCON13     |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDPHRCON13    | Name:^Pharmacy List Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDPHRCON13 | Name:^Pharmacy List Condition13 | Status:^Ready for Use | Type:^Single | Source:^Pharmacy List |                           | Pharmacy is not included in pharmacy list PTTPPHI7 | Single Pharmacy List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Search and View PharmacyList Condition using Condition Name
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name                      | Status        | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name             | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                     | Header_Status         | Header_Type  | View_Source           | View_Benefit_Customer_Set | View_Condition_Description                         | Notes                          | Tags          |
      | QTP_Master_1        | Single |              | Pharmacy List Condition13 | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDPHRCON13    | Name:^Pharmacy List Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDPHRCON13 | Name:^Pharmacy List Condition13 | Status:^Ready for Use | Type:^Single | Source:^Pharmacy List |                           | Pharmacy is not included in pharmacy list PTTPPHI7 | Single Pharmacy List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Search and View PharmacyList Condition using Condition ID and Source details
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status        | Source        | Field | Benefit_Customer_Set | List     | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name             | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                     | Header_Status         | Header_Type  | View_Source           | View_Benefit_Customer_Set | View_Condition_Description                         | Notes                          | Tags          |
      | QTP_Master_1        | Single | PHRCON13     |      | Ready for Use | Pharmacy List |       |                      | PTTPPHI7 | Master customer set:^QTP_Master_1  | Condition ID:^CDPHRCON13    | Name:^Pharmacy List Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDPHRCON13 | Name:^Pharmacy List Condition13 | Status:^Ready for Use | Type:^Single | Source:^Pharmacy List |                           | Pharmacy is not included in pharmacy list PTTPPHI7 | Single Pharmacy List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View PharmacyList Condition from Search Results table using Master Customer Set and Sub-status
    ...
    Examples: 
      ...
      | QTP_Master_1        |      |              |      | Ready for Use |        |       |                      |      | Not Associated |      |                          |                             | View      | CDPHRCON13        | Master customer set:^QTP_Master_1  | Condition ID:^CDPHRCON13    | Name:^Pharmacy List Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDPHRCON13 | Name:^Pharmacy List Condition13 | Status:^Ready for Use | Type:^Single | Source:^Pharmacy List |                           | Pharmacy is not included in pharmacy list PTTPPHI7 | Single Pharmacy List Condition | Tag Name^tag1 |    
  ...
  Scenario Outline: Advanced Search and View PharmacyList Condition from Search Results table using Master Customer Set, Type and Sub-status
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Sub_Status     | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name             | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                     | Header_Status         | Header_Type  | View_Source           | View_Benefit_Customer_Set | View_Condition_Description                         | Notes                          | Tags          |
      | QTP_Master_1        | Single |              |      | Ready for Use |        |       |                      |      | Not Associated |      |                          |                             | View      | CDPHRCON13        | Master customer set:^QTP_Master_1  | Condition ID:^CDPHRCON13    | Name:^Pharmacy List Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDPHRCON13 | Name:^Pharmacy List Condition13 | Status:^Ready for Use | Type:^Single | Source:^Pharmacy List |                           | Pharmacy is not included in pharmacy list PTTPPHI7 | Single Pharmacy List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View PharmacyList Condition using Condition ID and Sub-status
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Sub_Status     | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name             | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                     | Header_Status         | Header_Type  | View_Source           | View_Benefit_Customer_Set | View_Condition_Description                         | Notes                          | Tags          |
      | QTP_Master_1        | Single | PHRCON13     |      | Ready for Use |        |       |                      |      | Not Associated |      |                          |                             |           |                   | Master customer set:^QTP_Master_1  | Condition ID:^CDPHRCON13    | Name:^Pharmacy List Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDPHRCON13 | Name:^Pharmacy List Condition13 | Status:^Ready for Use | Type:^Single | Source:^Pharmacy List |                           | Pharmacy is not included in pharmacy list PTTPPHI7 | Single Pharmacy List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View PharmacyList Condition using Condition Name and Sub-status
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name                      | Status        | Source | Field | Benefit_Customer_Set | List | Sub_Status     | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name             | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                     | Header_Status         | Header_Type  | View_Source           | View_Benefit_Customer_Set | View_Condition_Description                         | Notes                          | Tags          |
      | QTP_Master_1        | Single |              | Pharmacy List Condition13 | Ready for Use |        |       |                      |      | Not Associated |      |                          |                             |           |                   | Master customer set:^QTP_Master_1  | Condition ID:^CDPHRCON13    | Name:^Pharmacy List Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDPHRCON13 | Name:^Pharmacy List Condition13 | Status:^Ready for Use | Type:^Single | Source:^Pharmacy List |                           | Pharmacy is not included in pharmacy list PTTPPHI7 | Single Pharmacy List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Advanced Search and View PharmacyList Condition using Condition ID, Sub-status and Source details
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status        | Source        | Field | Benefit_Customer_Set | List     | Sub_Status     | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name             | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                     | Header_Status         | Header_Type  | View_Source           | View_Benefit_Customer_Set | View_Condition_Description                         | Notes                          | Tags          |
      | QTP_Master_1        | Single | PHRCON13     |      | Ready for Use | Pharmacy List |       |                      | PTTPPHI7 | Not Associated |      |                          |                             |           |                   | Master customer set:^QTP_Master_1  | Condition ID:^CDPHRCON13    | Name:^Pharmacy List Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDPHRCON13 | Name:^Pharmacy List Condition13 | Status:^Ready for Use | Type:^Single | Source:^Pharmacy List |                           | Pharmacy is not included in pharmacy list PTTPPHI7 | Single Pharmacy List Condition | Tag Name^tag1 |
 ...
 #Scenario Outline: Search and View PharmacyList Condition using Condition ID, Sub status and Tags       ***** This Search condition is commented due to application issue with Tags *****
    ...
    #Examples: 
      #| Master_Customer_Set | Type   | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Sub_Status     | Tags     | Tags_Add_Success_Message                 | Tags_Remove_Success_Message                           | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name             | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                     | Header_Status         | Header_Type  | View_Source           | View_Benefit_Customer_Set | View_Condition_Description                         | Notes                          | Tags          |
      #| QTP_Master_1        | Single | PHRCON13     |      | Ready for Use |        |       |                      |      | Not Associated | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. |           |                   | Master customer set:^QTP_Master_1  | Condition ID:^CDPHRCON13    | Name:^Pharmacy List Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDPHRCON13 | Name:^Pharmacy List Condition13 | Status:^Ready for Use | Type:^Single | Source:^Pharmacy List |                           | Pharmacy is not included in pharmacy list PTTPPHI7 | Single Pharmacy List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Wildcard search using Condition ID and View PharmacyList Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status        | Source | Field | Benefit_Customer_Set | List | Sub_Status | Tags | Tags_Add_Success_Message | Tags_Remove_Success_Message | Operation | View_Condition_ID | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name             | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID      | Header_Name                     | Header_Status         | Header_Type  | View_Source           | View_Benefit_Customer_Set | View_Condition_Description                         | Notes                          | Tags          |
      | QTP_Master_1        | Single | *CON*        |      | Ready for Use |        |       |                      |      |            |      |                          |                             | View      | CDPHRCON13        | Master customer set:^QTP_Master_1  | Condition ID:^CDPHRCON13    | Name:^Pharmacy List Condition13 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDPHRCON13 | Name:^Pharmacy List Condition13 | Status:^Ready for Use | Type:^Single | Source:^Pharmacy List |                           | Pharmacy is not included in pharmacy list PTTPPHI7 | Single Pharmacy List Condition | Tag Name^tag1 |
