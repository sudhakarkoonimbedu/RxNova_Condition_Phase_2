Feature: Copy Compound Condition with AND operator and Ready for Use status from Search Results table
  ...
  Scenario Outline: Delete the created conditions
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Compound | CMPCPY16     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
      | QTP_Master_1        | Compound | CMPCON16     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Compound Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | CMPCON16     | Compound Condition16 | Ready for Use | Compound | AND               | Add^TPCOND19^TPCOND20 | Compound Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: Copy Single DrugList Condition from Search Results table
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | Ready for Use | Copy      | CDCMPCON16   | CMPCPY16          | Compound Condition Copy16 | Ready for Use | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Compound AND Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCPY16     |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCPY16    | Name:^Compound Condition Copy16 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCPY16 | Name:^Compound Condition Copy16 | Status:^Ready for Use | Type:^Compound | Compound operator:^AND | Condition ID^CDTPCOND19 | Name^TPCOND19        | Condition ID^CDTPCOND20 | Name^TPCOND20        | CDCMPCPY16: (COMPOUND CODE is the same as 1 AND NDC Name is not the same as 18860067870) | CDCMPCPY16: Compound Condition Copy16 | CDTPCOND19: COMPOUND CODE is not the same as 1^AND^CDTPCOND20: NDC Name is not same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Compound Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCPY16     |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
      | QTP_Master_1        | Compound | CMPCON16     |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |