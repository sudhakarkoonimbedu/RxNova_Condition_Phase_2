Feature: Copy Compound Condition with OR operator and Do Not Use Anymore status
  ...
  Scenario Outline: Delete the created conditions
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Compound | CMPCPY9      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
      | QTP_Master_1        | Compound | CMPCON9      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Compound Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | CMPCON9      | Compound Condition9 | Do Not Use Anymore | Compound | OR                | Add^TPCOND17^TPCOND18 | Compound Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: Copy Compound OR Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCON9      |      | Do Not Use Anymore |        |       |                      |      | CMPCPY9           | Compound Condition Copy9 | Do Not Use Anymore | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Compound OR Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCPY9      |      | Do Not Use Anymore |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCPY9     | Name:^Compound Condition Copy9 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCPY9 | Name:^Compound Condition Copy9 | Status:^Do Not Use Anymore | Type:^Compound | Compound operator:^OR  | Condition ID^CDTPCOND17 | Name^TPCOND17        | Condition ID^CDTPCOND18 | Name^TPCOND18        | CDCMPCPY9: (COMPOUND CODE is the same as 1 OR NDC Name is not the same as 18860067870) | CDCMPCPY9: Compound Condition Copy9 | CDTPCOND17: COMPOUND CODE is the same as 1^OR^CDTPCOND18: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Compound Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCPY9      |      | Do Not Use Anymore |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
      | QTP_Master_1        | Compound | CMPCON9      |      | Do Not Use Anymore |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |