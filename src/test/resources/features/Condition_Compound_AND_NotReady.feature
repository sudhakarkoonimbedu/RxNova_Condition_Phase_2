...
Feature: Compound Condition with AND operator and Not Ready status
  ...
  Scenario Outline: Delete the created condition
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Compound | CMPCON2      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Compound Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | CMPCON2      | Compound Condition2 | Not Ready | Compound | AND               | Add^TPCOND5^TPCOND6   | Compound Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: View the Compound Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCON2      |      | Not Ready |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON2     | Name:^Compound Condition2 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON2 | Name:^Compound Condition2 | Status:^Not Ready | Type:^Compound | Compound operator:^AND | Condition ID^CDTPCOND5 | Name^TPCOND5         | Condition ID^CDTPCOND6 | Name^TPCOND6         | CDCMPCON2: (COMPOUND CODE is the same as 1 AND NDC Name is not the same as 18860067870) | CDCMPCON2: Compound Condition2     | CDTPCOND5: COMPOUND CODE is the same as 1^AND^CDTPCOND6: NDC Name is not the same as 18860067870 | Compound Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Update the Compound Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCON2      |      | Not Ready |           |       |                      |      | Update Tracking ID | Update Test Reason | Update Test Notes | Update Compound Condition2 | Not Ready     | AND                      | Remove^CDTPCOND5^CDTPCOND6#Add^TPCOND7^TPCOND8 | Update Compound Condition | Remove^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully saved. | 
  ...
  Scenario Outline: View the Compound Condition
    ...
    Examples: 
      | Master_Customer_Set | Type     | Condition_ID | Name | Status    | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name              | Header_Summary_Status | Header_Master_Customer_Set    | Header_Condition_ID     | Header_Name                      | Header_Status     | Header_Type    | View_Compound_Operator | View_Condition_ID1     | View_Condition_Name1 | View_Condition_ID2     | View_Condition_Name2 | View_Condition_Description                                                               | View_Condition_Details_Description    | View_Condition_Details                                                                            | Notes                     | Tags |
      | QTP_Master_1        | Compound | CMPCON2      |      | Not Ready |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDCMPCON2     | Name:^Update Compound Condition2 | Status:^Not Ready | Master customer set:^QTP_Master_1 | Condition ID:^CDCMPCON2 | Name:^Update Compound Condition2 | Status:^Not Ready | Type:^Compound | Compound operator:^AND | Condition ID^CDTPCOND7 | Name^TPCOND7         | Condition ID^CDTPCOND8 | Name^TPCOND8         | CDCMPCON2: (NDC Name is the same as 18860067870 AND NDC Name is the same as 18860067870) | CDCMPCON2: Update Compound Condition2 | CDTPCOND7: NDC Name is the same as 18860067870^AND^CDTPCOND8: NDC Name is the same as 18860067870 | Update Compound Condition |      |
  ...
  Scenario Outline: Delete the Compound Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Compound | CMPCON2      |      | Not Ready |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |