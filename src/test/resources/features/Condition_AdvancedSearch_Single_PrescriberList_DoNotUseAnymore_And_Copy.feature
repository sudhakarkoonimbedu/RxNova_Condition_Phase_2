Feature: Advanced Search Single Prescriber List Condition with Do Not Use Anymore status And Copy the Condition
  ...
  Scenario Outline: Delete the created conditions
  	...
  	Examples:
  		...
  		| QTP_Master_1        | Single | PRECPY15      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
 ...
 #Scenario Outline: Search and View PrescriberList Condition using Condition ID, Sub status and Tags       ***** This Search condition is commented due to application issue with Tags *****
  ...
  Scenario Outline: Copy Single PrescriberList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | PRECON15      |      | Do Not Use Anymore |        |       |                      |      | PRECPY15           | Prescriber List Condition Copy15 | Do Not Use Anymore | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Single PrescriberList Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status             | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name                   | Header_Summary_Status      | Header_Master_Customer_Set        | Header_Condition_ID     | Header_Name                           | Header_Status              | Header_Type  | View_Source             | View_Benefit_Customer_Set          | View_Condition_Description                         | Notes                            | Tags          |
      | QTP_Master_1        | Single | PRECPY15      |      | Do Not Use Anymore |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDPRECPY15     | Name:^Prescriber List Condition Copy15 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDPRECPY15 | Name:^Prescriber List Condition Copy15 | Status:^Do Not Use Anymore | Type:^Single | Source:^Prescriber List | Benefit customer set:^QTP_Benefits | Prescriber is included in prescriber list PBTPPRI6 | Single Prescriber List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Single PrescriberList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | PRECPY15      |      | Do Not Use Anymore |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |    
