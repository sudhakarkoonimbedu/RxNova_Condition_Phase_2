Feature: Single Field Price Source Condition with Ends With operator and Not Ready status
  ...
  Scenario Outline: Delete the created condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Single | FPSCON5      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single Field Price Source Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | FPSCON5      | Field PRS Condition5 | Not Ready | Single | Field  | PRICE SOURCE | Ends With      | X           |                      |          |       | Single Field Price Source Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: View the Single Field Price Source Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FPSCON5      |      | Not Ready |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFPSCON5     | Name:^Field PRS Condition5 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDFPSCON5 | Name:^Field PRS Condition5 | Status:^Not Ready | Type:^Single | Source:^Field |                           | PRICE SOURCE ends with X   | Single Field Price Source Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Update the Single Field Price Source Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FPSCON5      |      | Not Ready |        |       |                      |      | Update Tracking ID | Update Test Reason | Update Test Notes | Update Field PRS Condition5 | Not Ready     | Field         | PRICE SOURCE      | Ends With             | X                  |                 |              | Update Single Field Price Source Condition | Remove^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully saved. | 
  ...
  Scenario Outline: View the Single Field Price Source Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status    | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name               | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID     | Header_Name                       | Header_Status     | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description | Notes                                      | Tags |
      | QTP_Master_1        | Single | FPSCON5      |      | Not Ready |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFPSCON5     | Name:^Update Field PRS Condition5 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDFPSCON5 | Name:^Update Field PRS Condition5 | Status:^Not Ready | Type:^Single | Source:^Field |                           | PRICE SOURCE ends with X   | Update Single Field Price Source Condition |      |
  ...
  Scenario Outline: Delete the Single Field Price Source Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FPSCON5      |      | Not Ready |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |