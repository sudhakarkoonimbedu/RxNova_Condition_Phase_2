Feature: Copy Single Prescriber List Condition with Not Ready status from Search Results table
  ...
  Scenario Outline: Delete the created conditions
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Single | PRECPY11     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
      | QTP_Master_1        | Single | PRECON11     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single PrescriberList Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | PRECON11     | Prescriber List Condition11 | Not Ready | Single | Prescriber List |            |                |             | QTP_Benefits         | Is Not Included In | PBTPPRI5 | Single Prescriber List Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: Copy Single PrescriberList Condition from Search Results table
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | Not Ready | Copy      | CDPRECON11   | PRECPY11          | Prescriber List Condition Copy11 | Not Ready   | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Single PrescriberList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | PRECPY11     |      | Not Ready |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDPRECPY11    | Name:^Prescriber List Condition Copy11 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDPRECPY11 | Name:^Prescriber List Condition Copy11 | Status:^Not Ready | Type:^Single | Source:^Prescriber List | Benefit customer set:^QTP_Benefits | Prescriber is not included in prescriber list PBTPPRI5 | Single Prescriber List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Single PrescriberList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | PRECPY11     |      | Not Ready |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
      | QTP_Master_1        | Single | PRECON11     |      | Not Ready |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
