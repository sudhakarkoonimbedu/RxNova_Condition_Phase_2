...
Feature: Single Field QUANTITY Condition with Is Not Equal To operator and Not Ready status
  ...
  Scenario Outline: Delete the created condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Single | FQTCON5      |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single Field QUANTITY Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | FQTCON5      | Field QTY Condition5 | Not Ready | Single | Field  | QUANTITY   | Is Not Equal To | 20          |                      |          |       | Single Field QTY Condition5 | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: View the Single Field QUANTITY Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FQTCON5      |      | Not Ready |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFQTCON5     | Name:^Field QTY Condition5 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDFQTCON5 | Name:^Field QTY Condition5 | Status:^Not Ready | Type:^Single | Source:^Field |                           | QUANTITY is not equal to 20 | Single Field QTY Condition5 | Tag Name^tag1 |
  ...
  Scenario Outline: Update the Single Field QUANTITY Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FQTCON5      |       | Not Ready |           |       |                      |      | Update Tracking ID | Update Test Reason | Update Test Notes | Update Field QTY Condition5 | Not Ready     | Field         |                   |                       |                    | Is Not Equal To | 20           | Update Field QTY Condition5 | Remove^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully saved. | 
  ...
  Scenario Outline: View the Single Field QUANTITY Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status    | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name               | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID     | Header_Name                       | Header_Status     | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description  | Notes                       | Tags |
      | QTP_Master_1        | Single | FQTCON5      |      | Not Ready |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFQTCON5     | Name:^Update Field QTY Condition5 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDFQTCON5 | Name:^Update Field QTY Condition5 | Status:^Not Ready | Type:^Single | Source:^Field |                           | QUANTITY is not equal to 20 | Update Field QTY Condition5 |      |
  ...
  Scenario Outline: Delete the Single Field QUANTITY Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FQTCON5      |      | Not Ready |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |