...
Feature: Copy Single Field DEA Condition with Ready for Use status from Search Results table
  ...
  Scenario Outline: Delete the created conditions
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Single | FDECPY10     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
      | QTP_Master_1        | Single | FDECON10     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single Field DEA Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | FDECON10     | Field DEA Condition10 | Ready for Use | Single | Field  | DEA CODE   | Does Not Include | A           |                      |          |       | Single Field DEA Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: Copy Single Field DEA Condition from Search Results table
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | Ready for Use | Copy      | CDFDECON10   | FDECPY10          | Field DEA Condition Copy10 | Ready for Use | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Single Field DEA Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FDECPY10     |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFDECPY10    | Name:^Field DEA Condition Copy10 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDFDECPY10 | Name:^Field DEA Condition Copy10 | Status:^Ready for Use | Type:^Single | Source:^Field DEA |                           | DEA CODE does not include A | Single Field DEA Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Single Field DEA Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FDECPY10     |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
      | QTP_Master_1        | Single | FDECON10     |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
