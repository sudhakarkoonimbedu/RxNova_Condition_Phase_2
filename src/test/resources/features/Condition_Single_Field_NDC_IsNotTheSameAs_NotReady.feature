...
Feature: Single Field NDC Name Condition with Is Not the Same As operator and Not Ready status
  ...
  Scenario Outline: View the Single Field NDC Name Condition
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status    | Source | Field | Benefit_Customer_Set | List | Header_Summary_Master_Customer_Set | Header_Summary_Condition_ID | Header_Summary_Name               | Header_Summary_Status | Header_Master_Customer_Set        | Header_Condition_ID     | Header_Name                       | Header_Status     | Header_Type  | View_Source   | View_Benefit_Customer_Set | View_Condition_Description              | Notes                              | Tags |
      | QTP_Master_1        | Single | FNDCON5      |      | Not Ready |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFNDCON5     | Name:^Update Field NDC Condition5 | Status:^Not Ready     | Master customer set:^QTP_Master_1 | Condition ID:^CDFNDCON5 | Name:^Update Field NDC Condition5 | Status:^Not Ready | Type:^Single | Source:^Field |                           | NDC Name Is Not the Same As 89759612315 | Update Single Field NDC Condition5 |      |
