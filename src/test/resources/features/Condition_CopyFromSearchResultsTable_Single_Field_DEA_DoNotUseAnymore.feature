...
Feature: Copy Single Field DEA Condition with Do Not Use Anymore status from Search Results table
  ...
  Scenario Outline: Delete the created conditions
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Single | FDECPY12     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
      | QTP_Master_1        | Single | FDECON12     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Add the Single Field DEA Condition
    ...
    Examples: 
      ...
      | Test TrackingID    | Test Reason   | Test Notes   | QTP_Master_1        | FDECON12     | Field DEA Condition12 | Do Not Use Anymore | Single | Field  | DEA CODE   | Does Not Include | C           |                      |          |       | Single Field DEA Condition | Add^Tag1 | Tag successfully added to the condition. | Tag(s) successfully removed from the search criteria. | The condition was successfully added. |
  ...
  Scenario Outline: Copy Single Field DEA Condition from Search Results table
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | Do Not Use Anymore | Copy      | CDFDECON12   | FDECPY12          | Field DEA Condition Copy12 | Do Not Use Anymore | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Single Field DEA Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FDECPY12     |      | Do Not Use Anymore |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDFDECPY12    | Name:^Field DEA Condition Copy12 | Status:^Do Not Use Anymore | Master customer set:^QTP_Master_1 | Condition ID:^CDFDECPY12 | Name:^Field DEA Condition Copy12 | Status:^Do Not Use Anymore | Type:^Single | Source:^Field DEA |                           | DEA CODE does not include C | Single Field DEA Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Single Field DEA Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | FDECPY12     |      | Do Not Use Anymore |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
      | QTP_Master_1        | Single | FDECON12     |      | Do Not Use Anymore |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
