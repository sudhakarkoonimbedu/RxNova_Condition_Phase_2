...
Feature: Copy Single Pharmacy List Condition with Ready for Use status from Search Results table
  ...
  Scenario Outline: Delete the created conditions
    ...
    Examples: 
      | Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
      | QTP_Master_1        | Single | PHRCPY10     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
      | QTP_Master_1        | Single | PHRCON10     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
  ...
  Scenario Outline: Copy Single PharmacyList Condition from Search Results table
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | Ready for Use | Copy      | CDPHRCON10   | PHRCPY10          | Pharmacy List Condition Copy10 | Ready for Use | Test TrackingID |             |            | The condition was successfully copied. |
  ...
  Scenario Outline: View the Copied Single PharmacyList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | PHRCPY10     |      | Ready for Use |        |       |                      |      | Master customer set:^QTP_Master_1  | Condition ID:^CDPHRCPY10    | Name:^Pharmacy List Condition Copy10 | Status:^Ready for Use | Master customer set:^QTP_Master_1 | Condition ID:^CDPHRCPY10 | Name:^Pharmacy List Condition Copy10 | Status:^Ready for Use | Type:^Single | Source:^Pharmacy List |                           | Pharmacy is not included in pharmacy list PTTPPHI4 | Single Pharmacy List Condition | Tag Name^tag1 |
  ...
  Scenario Outline: Delete the Single PharmacyList Condition
    ...
    Examples: 
      ...
      | QTP_Master_1        | Single | PHRCPY10     |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
      | QTP_Master_1        | Single | PHRCON10     |      | Ready for Use |        |       |                      |      | Update Tracking ID |               |              |             | Not Ready     | The condition was successfully saved. | Delete Tracking ID | Delete Reason | Delete Notes | The condition was successfully deleted. |
