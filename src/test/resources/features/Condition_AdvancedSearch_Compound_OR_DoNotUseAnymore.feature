Feature: Advanced Search Compound Condition with OR operator and Do Not Use Anymore status
  ...
  Scenario Outline: Delete the created conditions
  	...
  	Examples:
  		| Master_Customer_Set | Type   | Condition_ID | Name | Status | Update_Tracking_ID | Update_Status | Delete_Tracking_ID |
  		| QTP_Master_1        | Single | CMPCON24     |      |        | Update Tracking ID | Not Ready     | Delete Tracking ID |
